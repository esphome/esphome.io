...
ESP heap memory (free space, maximum free block size and fragmentation level) and the main-loop timing. Monitoring can be done in the terminal or web server component if it has been configured.
