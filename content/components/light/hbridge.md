...
- **pin_a** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the first float [Output Component](#output) to use for this light.
- **pin_b** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the second float [Output Component](#output) to use for this light.
