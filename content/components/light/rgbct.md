...
- **red** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the float [Output Component](#output) to use for the red channel.
- **green** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the float [Output Component](#output) to use for the green channel.
- **blue** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the float [Output Component](#output) to use for the blue channel.
- **color_temperature** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the float [Output Component](#output) to use for the
  color temperature channel.

- **white_brightness** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the float [Output Component](#output) to use for the brightness
  of the white leds.
