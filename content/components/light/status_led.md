...
- **pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The GPIO pin to operate the LED on.
...
> `inverted` option of the [Pin Schema](/guides/configuration-types#pin):
>
> ```yaml
> pin:
>   number: GPIOXX
