...
- **read_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin that the receiver is connected to
- **write_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): the pin that the transmitter is connected to
