...
- **id** (**Required**, [ID](/guides/configuration-types#config-id)): The id to use for this `pi4ioe5v6408` component.
...
- **pi4ioe5v6408** (**Required**, [ID](/guides/configuration-types#config-id)): The id of the `pi4ioe5v6408` component of the pin.
