...
The component can be configured using [GPIO pins](/guides/configuration-types#pin) or the [SPI Bus](/components/spi).
...
- **data_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Pin connected to SN74HC595 SER (SD) input.
- **clock_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Pin connected to SN74HC595 SRCLK (SH_CP) pin
- **latch_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Pin connected to SN74HC595 RCLK (ST_CP) pin
- **oe_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): Pin connected to SN74HC595 OE pin
