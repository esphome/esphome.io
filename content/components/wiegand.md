...
- **d0** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin where the `D0` output
  of the Wiegand's interface connects.

- **d1** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin where the `D1` output
  of the Wiegand's interface connects.
