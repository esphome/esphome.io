...
- **aqi** (*Optional*, **Deprecated**): AQI sensor. Requires the `pm_2_5` and `pm_10_0` sensors defined. See below.
...
> standalone [AQI sensor platform](/components/sensor/aqi) instead, which works with
> any PM sensor source.
