...
The `sy6970` component allows you to use SY6970 battery management and charging ICs with ESPHome. The [I²C Bus](/components/i2c) is required in your configuration for this sensor to work.
...
This component is commonly found in devices like the LilyGo T-Display S3 Pro.

{{< img src="sy6970.jpg" alt="Image" caption="SY6970 Battery Management IC" width="50.0%" class="align-center" >}}
...
- **address** (*Optional*, int): The I²C address of the device. Defaults to `0x6B`.
...
- `enable_charge()` - Enable battery charging
- `disable_charge()` - Disable battery charging
- `enable_status_led()` - Enable the status LED
- `disable_status_led()` - Disable the status LED
- `enable_adc_measure()` - Enable ADC measurements
...
- {{< apiref "sy6970/sy6970.h" "sy6970/sy6970.h" >}}
````