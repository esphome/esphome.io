...
- **input_current_limit** (*Optional*, int): Input current in milliamps. Accepts values between 100 and 3200. No default value.
- **charge_voltage** (*Optional*, int): Charge voltage in millivolts. Accepts values between 3840 and 4608. No default value.
- **charge_current**  (*Optional*, int): Charge current in milliamps. Accepts values between 0 and 5056. No default value.
- **precharge_current**  (*Optional*, int): Pre-charge current in milliamps. Accepts values between 64 and 1024. No default value.
- **charge_enabled** (*Optional*, boolean): Enable or disable charging
- **enable_adc** (*Optional*, boolean): Enable or disable the ADC.
