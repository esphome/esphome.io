...
required to be set up in your configuration for this sensor to work. This sensor also has SPI communication support, but it is not currently supported in ESPHome.
...
- **address** (*Optional*, int): _I²C Only_ Manually specify the I²C address of
