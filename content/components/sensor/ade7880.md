...
- **irq1_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)):
...
- **irq0_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)):
...
- **reset_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)):
