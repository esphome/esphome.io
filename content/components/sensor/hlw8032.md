...
([datasheet](https://v4.cecdn.yun300.cn/100001_2107285051/DS_HLW8032_EN_Rev1.5.pdf)) sensors with
...
to have an [UART bus](#uart) in your configuration with the `rx_pin`   connected to the HLW8032.
