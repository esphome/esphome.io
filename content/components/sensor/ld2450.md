...
- **on_data** (*Optional*, [Action](/automations/actions#all-actions)): An automation to perform after each report is received. This means
  that all values for all targets are up-to-date and consistent, rather than trying to add an action to individual sensor values.
