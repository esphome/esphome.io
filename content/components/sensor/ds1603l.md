...
DS1603L V1.0 Ultrasonic Sensor over UART with Level, Volume and Percentage without modification.
...
################
  - platform: ds1603l 
    ...
    ds1603l_min_level: 0.0                       # set minimum level in mm. can be negative for standpipe below tank. offsets here change volume and percentage
    ...
    ds1603l_liquid_level:                        # get level in mm. sensor natively outputs mm
      ...
      filters:                           # some filters I found useful
        - filter_out: nan
        - delta: 1.0
    ds1603l_liquid_volume:               # volume is calculated from level
      name: "DS1603L 1 Volume"
      unit_of_measurement: "gal"         # any unit of measurement acceptable
      filters:
        - filter_out: nan
        - delta: 1.0
    ds1603l_percentage:                  # percentage is calculated from volume
