...
- **id** (*Optional*, [ID](/guides/configuration-types#config-id)): Manually specify the ID for this {{< docref "ld2410/" >}} component if you need multiple
  components.
...
- **ld2410_id** (*Optional*, [ID](/guides/configuration-types#config-id)): Manually specify the ID for the {{< docref "ld2410/" >}} component if you are
