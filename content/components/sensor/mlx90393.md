...
- **drdy_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): Data-ready pin. Often labelled `INT`. Using this pin might lead to slightly quicker read times.
