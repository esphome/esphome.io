...
- **address** (*Optional*, int): Manually specify the I²C address of the sensor. Defaults to `0x68`. Use `0x68` when SDO is connected to GND, or `0x69` when SDO is connected to VCC.
