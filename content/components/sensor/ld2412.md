...
- **uart_id** (*Optional*, [ID](/guides/configuration-types#config-id)): Manually specify the ID of the [UART Component](/components/uart), which is
...
- **ld2412_id** (*Optional*, [ID](/guides/configuration-types#config-id)): Manually specify the ID for the component. Required when using multiple
  components.
