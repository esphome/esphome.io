...
{{< img src="gps-full.jpg" alt="GPS Module" caption="GPS Module. Image by [Adafruit](https://www.adafruit.com/product/746)" width="50.0%" class="align-center" >}}
...
- **uart_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID of the [UART Component](/components/uart), or of the [Nmea](/components/modem#nmea_schema) from the [Modem](/components/modem)
