...
- **dwl_req_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The pin connected to the PN7150's
  `DWL_REQ` line. Used to invoke the PN7150's firmware update mode; may be used in a future release.

- **irq_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin connected to the PN7150's `IRQ` line.
- **ven_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin connected to the PN7150's `VEN` line.
- **wkup_req_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The pin connected to the PN7150's
