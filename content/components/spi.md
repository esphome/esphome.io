...
- **clk_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin used for the clock line of the SPI bus.
...
- **mosi_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The pin used for the MOSI line of the SPI bus.
- **miso_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The pin used for the MISO line of the SPI bus.

For `quad` or `octal` type instead specify `data_pins`  :

- **data_pins** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Must be a list of exactly 4 pins to be used
