...
- **data_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin used for MOSI.
- **clock_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin which SCLK is
   connected to.
