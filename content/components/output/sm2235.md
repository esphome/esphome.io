...
- **data_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin used for DATA.
- **clock_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin which CLK is
   connected to.
