...
- **data_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin which DI is connected
   to.

- **clock_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin which DCKI is
   connected to.
