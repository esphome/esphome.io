...
- **cs_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Chip Select pin
- **inc_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Increment pin
- **ud_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Up/Down pin
