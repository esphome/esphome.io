...
- **data_pins** (**Required**): A list of pins used for the databus. Specified in 3 groups:
  ...
  - **red** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Exactly 5 pin numbers for the red databits, listed from least to most significant bit.
  - **green** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Exactly 6 pin numbers for the green databits, listed from least to most significant bit.
  - **blue** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Exactly 5 pin numbers for the blue databits, listed from least to most significant bit.
...
- **enable_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The ENABLE pin.
