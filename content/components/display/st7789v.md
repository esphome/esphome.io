...
- **cs_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The CS pin. Defaults depends `model`.
- **dc_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The DC pin. Defaults depends `model`.
- **reset_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The RESET pin. Defaults depends `model`.
...
- **backlight_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The display's backlight pin. May be required
