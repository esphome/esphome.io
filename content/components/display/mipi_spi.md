...
- **dc_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The DC pin. Not required or permitted for quad SPI.
...
- **enable_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): An optional pin to enable the display, if required. A list of pins can be provided for displays that require multiple enable pins. A full pin configuration may be provided
