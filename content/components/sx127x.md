...
This [action](/automations/actions#config-action) runs the `sx127x` image calibration, must be in standby mode.
...
This [action](/automations/actions#config-action) sets the `sx127x` mode to tx.
...
This [action](/automations/actions#config-action) sets the `sx127x` mode to rx.
...
This [action](/automations/actions#config-action) sets the `sx127x` mode to sleep.
...
This [action](/automations/actions#config-action) sets the `sx127x` mode to standby.
...
This [action](/automations/actions#config-action) sends a packet, the `sx127x` needs to be in packet mode.
