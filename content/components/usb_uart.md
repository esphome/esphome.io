...
- **id** (*Optional*, [ID](/guides/configuration-types#config-id)): The id to use for this component.
...
- **id** (*Optional*, [ID](/guides/configuration-types#config-id)): An id to assign to the channel. This id may be used anywhere a `uart` component is required.
