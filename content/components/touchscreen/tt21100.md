...
- **interrupt_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The touch detection pin.
- **reset_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin)): The reset pin of the controller.
