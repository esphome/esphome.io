...
- **pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): The pin to monitor.
...
you can do so with the [Pin Schema](/guides/configuration-types#pin).
...
Use the `inverted` property of the [Pin Schema](/guides/configuration-types#pin) to invert the binary
sensor:
...
- [Pin Schema](/guides/configuration-types#pin)
