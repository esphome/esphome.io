...
This [action](/automations/actions#config-action) runs the `sx126x` image calibration.
...
This [action](/automations/actions#config-action) sets the `sx126x` mode to tx.
...
This [action](/automations/actions#config-action) sets the `sx126x` mode to rx.
...
This [action](/automations/actions#config-action) sets the `sx126x` mode to sleep.
...
This [action](/automations/actions#config-action) sets the `sx126x` mode to standby.
...
This [action](/automations/actions#config-action) sends a packet.
