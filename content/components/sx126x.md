...
- **busy_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Busy pin.
- **cs_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): SPI chip select pin.
- **dio1_pin** (**Optional**, [Pin Schema](/guides/configuration-types#pin)): Digital IO pin 1.
- **rst_pin** (**Required**, [Pin Schema](/guides/configuration-types#pin)): Reset pin.
