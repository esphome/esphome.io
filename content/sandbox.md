            ...
            <table class="table table-sm">
              ...
              <tbody class="table-group-divider">
                <tr>
                  ...
                  <td
                    >Defines the operating mode the PSRAM should utilize. One of
                ...
                <tr>
                  ...
                  <td
                    >The speed at which the PSRAM should operate. One of
                ...
                <tr>
                  ...
                  <td
                    >For octal mode, enable ECC (Error Correction Code) for the
                ...
                <tr>
                  ...
                  <td><code>false</code></td>
                  <td
                    >Don’t try to initialize the PSRAM. This is needed if one of
              ...
              <tbody  class="table-group-divider">
                <tr>
                  ...
                  <td
                    >An automation to perform when the node starts. See <em>on_boot</em></td
                  >
                </tr>
                <tr>
                  ...
                  <td colspan="2">Automation</td>
                  <td
                    >An automation to perform right before the node shuts down. See <em>on_shutdow</em></td
                  >
                </tr>
                <tr>
                  ...
                  <td colspan="2">Automation</td>
                  <td
                    >An automation to perform on each loop() iteration. See <em>on_loop</em>.</td
                  >
                </tr>
              </tbody>
              <tfoot>
