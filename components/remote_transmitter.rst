...
.. _remote_transmitter-transmit_weather_station_2032:

``remote_transmitter.transmit_weather_station_2032`` **Action**

.. _remote_transmitter-transmit_weather_station_4ld631:

``remote_transmitter.transmit_weather_station_4ld631`` **Action**

.. _remote_transmitter-transmit_weather_station_h10515:

``remote_transmitter.transmit_weather_station_h10515`` **Action**

.. _remote_transmitter-transmit_weather_station_l08037a:

``remote_transmitter.transmit_weather_station_l08037a`` **Action**

.. _remote_transmitter-transmit_weather_station_nexus:

``remote_transmitter.transmit_weather_station_nexus`` **Action**

This :ref:`action <config-action>` sends weather station data to the receiver station.

.. code-block:: yaml

    on_...:
      - remote_transmitter.transmit_weather_station_2032:
          id: 240
          battery_level: 100
          channel: 0
          temperature: 21.5
...
- **humidity** (*Optional*, int): Measured humidity.
- **rain** (*Optional*, float): Measured rain in mm.
- **wind_direction_degrees** (*Optional*, float): Wind direction.
- **wind_speed** (*Optional*, float): Average wind speed in m/s.
- **wind_gust** (*Optional*, float): Wind gust speed in m/s.
