...
- **preamble_detect** (**Optional**, int): Minimum length of the preamble in bytes required by the receiver.
  Preamble detector is disabled if the size is 0 and its value capped at 3. Defaults to 2.
- **preamble_errors** (**Optional**, int): Number of chip errors tolerated in the receiver. Defaults to 10.
