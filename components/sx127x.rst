...
this data on ``pin`` (wired to DIO2).
...
:doc:`remote_transmitter </components/remote_transmitter>` should be used to send
this data on ``pin`` (wired to DIO2). The ``sx127x`` mode must be set appropriately
