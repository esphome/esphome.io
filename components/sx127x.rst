...
137 MHz to 1020 MHz. Supported modulations include LoRa, OOK, FSK, GFSK, MSK and GMSK. In conjunction
with the :ref:`packet-transport` it can be used to broadcast sensor data.
