SX1261/2/8 Component
================================================================

.. seo::
    :description: Instructions for setting up SX1261/SX1262/SX1268 transceivers.
    :image: sx126x.jpg

The ``sx126x`` component allows you to configure the SX1261, SX1262 and SX1268 transceivers
...
- **sync_value** (**Optional**, int): Synchronization word. The value 0x34 is reserved for LoRaWAN
  networks and the value 0x12 is meant for private networks. It is recommended to use only 0x12
  or 0x34. Defaults to 0x12.
...
This :ref:`action <config-action>` runs the ``sx126x`` image calibration, must be in standby mode.
...
This :ref:`action <config-action>` sends a packet, the ``sx126x`` needs to be in packet mode.
