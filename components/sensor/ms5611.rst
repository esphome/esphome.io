...
The ``ms5611`` sensor platform allows you to use your MS5611 (`datasheet`_) atmospheric pressure sensors temperature and pressure sensors with ESPHome. The :ref:`I²C <i2c>` is
