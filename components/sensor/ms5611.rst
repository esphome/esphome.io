...
The ``ms5611`` sensor platform allows you to use the MS5611 atmospheric pressure-and-temperature sensor with ESPHome (see the `datasheet`_ for technical details).
