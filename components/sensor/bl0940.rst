...
- **voltage_calibration** (*Optional*, :ref:`config-id`): The ID of the :doc:`Template Number Component </components/number/template>` to use for voltage calibration.
- **current_calibration** (*Optional*, :ref:`config-id`): The ID of the :doc:`Template Number Component </components/number/template>` to use for current calibration.
- **power_calibration** (*Optional*, :ref:`config-id`): The ID of the :doc:`Template Number Component </components/number/template>` to use to power calibration.
- **energy_calibration** (*Optional*, :ref:`config-id`): The ID of the :doc:`Template Number Component </components/number/template>` to use to energy calibration.
...
It is possible to adjust the sensor readings without need to update sensor configuration using a :doc:`Template Number Component </components/number/template>`.
