...
The ``ld2412`` binary sensor allows you to use your :doc:`ld2412` to perform different measurements.
...
- **dynamic_background_correction_status** (*Optional*): True while a the dynamic background correction is in progress.
  All options from :ref:`Binary Sensor <config-binary_sensor>`.
- **ld2412_id** (*Optional*, :ref:`config-id`): Manually specify the ID for the :doc:`ld2412` component. Required when
  using multiple components.

Sensor
------

The ``ld2412`` sensor allows you to use your :doc:`ld2412` to perform different measurements.
...
- **ld2412_id** (*Optional*, :ref:`config-id`): Manually specify the ID for the :doc:`ld2412`. Required when using
  multiple components.
