...
- **phase_status** (*Optional*): Reads out certain conditions detected by the meter: Over Current (>=65.53A), Over Voltage/Voltage Sag (calculated based on ``line_frequency`` - 60Hz = 120V, 50Hz = 220V - Sag = less than 78%, Over = greater than 122%), and Phase Loss. If none of these conditions, the output will be "Okay".
