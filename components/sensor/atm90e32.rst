...
- **phase_status** (*Optional*): Enables per-phase status conditions:
  ...
  - **phase_a** (*Optional*): Phase A status field. Will report:
    ...
    - **Phase Loss**: Indicates if the phase has dropped out.
      ...
      If no condition is met, the sensor reports ``Okay``. All options from :ref:`Text Sensor <text-sensor-component>`
...
- **freq_status** (*Optional*): Reports status based on frequency thresholds:
