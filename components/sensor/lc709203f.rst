...
(\`datasheet <https://cdn-learn.adafruit.com/assets/assets/000/094/597/original/LC709203F-D.PDF?1599248750>\`__) 
...
.. figure:: images/LC709203f_product_image.jpg
    :width: 40.0%
    
.. figure:: images/LC709203f_feather_product_image.jpg
    :width: 40.0%
...
- **temperature** (*Optional*): The setup information for the battery temperature sensor.
  ...
  - Note: the device does not have a built-in temperature sensor. Only enable this sensor 
          if you have attached a thermistor to the device as shown in :ref:`temperature-sensor`.
  - Standard options from :ref:`Sensor <config-sensor>`.
  - **name** (*Optional*): I suggest setting this one.
...
.. figure:: images/LC709203f_thermistor connection.jpg
    :align: center
    :width: 80.0%
