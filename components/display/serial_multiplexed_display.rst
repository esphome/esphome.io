...
.. seo::
    ...
    :image: serial_shift_register.jpg
...
.. figure:: images/serial_shift_register.jpg
    :align: center
    :width: 75.0%
...
.. _display-display-serial_multiplexed_display_lambda:
...
In the lambda you're passed a variable called ``it`` as with all other displays. In this case however, ``it`` is a SerialMultiplxedDisplay
