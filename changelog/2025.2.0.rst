...
this means a number of breaking changes, but this work helps keep ESPHome more maintainable in the long-run.
...
`ESP-IDF <https://github.com/espressif/esp-idf/>`__ in place of Arduino. This brought about a number of benefits and a
new syntax was introduced to facilitate greater flexibility when specifying and configuring your microcontroller/board.

In this release, we've removed support for the "old style" of configuring your microcontroller/board in this release.
If you're still using it, you'll need to update your configurations to use the new style. A brief explanation is
