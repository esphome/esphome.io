...
Removal of ``armv7`` Docker and Home Assistant add-on support
---------------------------------------------------------------

ESPHome no longer supports ``armv7`` (32-bit ARM) hardware. This is due to both waning support as it relates to tooling and
