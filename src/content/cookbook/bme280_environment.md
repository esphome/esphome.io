...
description: >-
  Instructions for setting up BME280 sensors in ESPHome and calculate altitude,
  absolute humidity, and sea level pressure.
seo:
  description: >-
    Instructions for setting up BME280 sensors in ESPHome and calculate
    altitude, absolute humidity, and sea level pressure.
  image: bme280.jpg
---
...
The second block uses the [absolute_humidity](/components/sensor/absolute_humidity) component which
...
- [absolute_humidity](/components/sensor/absolute_humidity)
