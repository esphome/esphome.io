...
description: >-
  Instructions for setting up a display in ESPHome to show sensor values from
  Home Assistant
seo:
  description: >-
    Instructions for setting up a display in ESPHome to show sensor values from
...
- Alignment of text can use different reference points, for example `TOP_RIGHT` or `BASELINE_LEFT`, which all are
  defined in ::apiref{text="display/display_buffer.h" path="display/display_buffer.h"}.
...
- [homeassistant](/components/sensor/homeassistant)
