...
The solution below handles the problem of RF frames being sent out by [rf_bridge](/components/rf_bridge) (or
[remote_transmitter](/components/remote_transmitter)) too quickly one after another when operating radio controlled
...
In this example a [time_based](/components/cover/time_based) is used with the GPIO configuration of a Sonoff Dual R2.
