...
::img{src="infostrip-detail.jpg" alt="Image" caption="Wemos D1 mini, Neopixel, CO2 sensor on a blackboard, pixelmeanings are described by the chalk drawn icons." width="75.0%" class="align-center"}
...
- [fastled](/components/light/fastled)
- [partition](/components/light/partition)
- [mhz19](/components/sensor/mhz19)
