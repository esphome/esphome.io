...
description: >-
  Instructions on using an Arduino board, like the Pro Mini for expanding ports
  of an ESPHome node
seo:
  description: >-
    Instructions on using an Arduino board, like the Pro Mini for expanding
    ports of an ESPHome node
