...
description: >-
  Getting Started guide for installing ESPHome Device Builder as a Home
  Assistant add-on and creating a basic configuration.
seo:
  description: >-
    Getting Started guide for installing ESPHome Device Builder as a Home
    Assistant add-on and creating a basic configuration.
...
>
> If you haven't done this before, please see [Link](physical_device_connection/).
...
>
> See [Link](getting_started_command_line/) for more detail.
...
Now is a great time to go take a look at the [Components Index](/index). Hopefully you'll find all the
...
[Discord chat](https://discord.gg/KhAMKrd). Be sure to read the [FAQ](faq), as well!

## See Also

- [ESPHome index](/index)
- [Link](getting_started_command_line/)
