...
:::option{name="-s|--substitution KEY VALUE"}
...
:::option{name="--device UPLOAD_PORT"}
...
:::option{name="--upload_speed BAUD_RATE"}
...
:::option{name="--device SERIAL_PORT"}
