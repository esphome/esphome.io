...
<Img src="infostrip-detail.jpg" alt="Image" caption="Wemos D1 mini, Neopixel, CO2 sensor on a blackboard, pixelmeanings are described by the chalk drawn icons." class="align-center" width="75.0%" />
...
<Img src="infostrip-lights-ui.png" alt="Image" caption="Each pixel is used as a light entity." class="align-center" width="50.0%" />
