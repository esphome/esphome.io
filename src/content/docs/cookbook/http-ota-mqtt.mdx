...
description: "Trigger OTA updates from the ESPHome dashboard using an HTTP server and MQTT."
---
...
Once configured, the **Publish** button appears in the ESPHome dashboard install dialog for any
