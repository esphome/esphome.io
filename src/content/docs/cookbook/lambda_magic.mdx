...
<a id="lambda_magic_pages" aria-hidden="true"></a>
...
<a id="lambda_magic_udp_sender" aria-hidden="true"></a>
...
<a id="lambda_magic_rf_queues" aria-hidden="true"></a>
...
<a id="lambda_magic_1button_coover" aria-hidden="true"></a>
