...
Mitsubishi heatpumps equipped with the `CN105` internal connector support reading temperature values from remote soensors.
...
The following is a possible configuration to implement this. Some heatpumps require frequent tempearture updates to prevent from
