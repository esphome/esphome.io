...
When using the ESP-IDF toolchain (`toolchain: esp-idf` in the configuration or the `--toolchain esp-idf` CLI parameter), ESPHome provides automatic framework management:
