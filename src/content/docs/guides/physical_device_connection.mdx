...
<Image src={nodemcuEsp8266Img} layout="constrained" alt="" />
...
<Image src={programmingHeaderPopulatedImg} layout="constrained" alt="" />
...
<Image src={programmingHeaderUnpopulatedImg} layout="constrained" alt="" />
...
<Image src={programmingHeaderFilledImg} layout="constrained" alt="" />
...
<Image src={moduleOnlyProgrammingImg} layout="constrained" alt="An ESP8266 module with programming wires soldered on" />
...
<Image src={programmingBareChipImg} layout="constrained" alt="A bare ESP8266 IC with no programming header" />
