...
> [!IMPORTANT]
The first successful `upload --partition-table` command changes the location of the NVS partition, invalidating all configuration data stored in non-volatile memory. If you used Captive Portal or Improv to configure your WiFi credentials you need to do that again before continuing to the next step.
