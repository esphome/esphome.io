...
<a id="devboard-as-flasher" aria-hidden="true"></a>
...
<Img src="devboard-as-flasher.png" alt="Image" caption="Connection diagram for an ESP flash target" class="align-center" width="75.0%" />
...
<a id="esp32s-usb-uart-bridge" aria-hidden="true"></a>
