...
<a id="faq-usb_installation" aria-hidden="true"></a>
...
<a id="esphome-esptool" aria-hidden="true"></a>
...
<a id="faq-usb_troubleshooting" aria-hidden="true"></a>
...
<a id="faq-bug_report" aria-hidden="true"></a>
...
<a id="faq-beta" aria-hidden="true"></a>
...
If it's not in [the docs](/), it's not (officially) supported. However, we are always adding
...
<a id="wifi-problems" aria-hidden="true"></a>
...
<a id="docker-reference-notes" aria-hidden="true"></a>
...
<a id="faq-notes_on_disabling_mdns" aria-hidden="true"></a>
...
<a id="strapping-warnings" aria-hidden="true"></a>
