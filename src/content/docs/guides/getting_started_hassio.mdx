...
<a id="installing-esphome-device-builder" aria-hidden="true"></a>
...
<Img src="addon.png" alt="Image" class="align-center" width="75.0%" />
...
<Img src="dashboard_empty.png" alt="Image" class="align-center" width="95.0%" />
...
>
> If you haven't done this before, please see [physical_device_connection/](/physical_device_connection/).
...
<a id="esphome-interface" aria-hidden="true"></a>

## Device Builder Interface

Let's take a quick tour of the ESPHome Device Builder interface.

<Img src="dashboard_states.png" alt="Image" class="align-center" width="95.0%" />
...
>
> See [getting_started_command_line/](/getting_started_command_line/) for more detail.
...
<Img src="gpio-ui.png" alt="Image" class="align-center" width="75.0%" />
...
<a id="connecting-your-device-to-home-assistant" aria-hidden="true"></a>
...
Now is a great time to go take a look at the [Components Index](/). Hopefully you'll find all the
