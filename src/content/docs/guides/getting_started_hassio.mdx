...
![Image](./images/dashboard_empty.png)
...
If you haven't done this before, please see [Physical Device Connection](/physical_device_connection/).
:::
...
![Image](./images/dashboard_states.png)
...
See [Getting Started Command Line](/getting_started_command_line/) for more detail.
:::
...
installed on your device) it can update the device [](/components/ota/index/).
