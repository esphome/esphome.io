...
- **width** (**Required**, int): Legend width in pixels. If not specified, width is automatically calculated.
- **height** (**Required**, int): Legend height in pixels. If not specified, height is automatically calculated.
