...
<Img src="tuya.png" alt="Image" class="align-center" width="40%" />
...
- **time_id** (*Optional*, [ID](/guides/configuration-types#id)): Some Tuya devices support obtaining local time from ESPHome.
  Specify the ID of the [time/](/time/) which will be used.
...
<a id="tuya-on_datapoint_update" aria-hidden="true"></a>
