...
- **on_start** (*Optional*, [Automation](/automations#automation)): Automation to run when the zigbee stack is fully initialized
  and could be interacted with. Next it will try to (re-)join a network.
