...
<Img src="modbus.png" alt="Image" class="align-center" width="25%" />
...
<a id="modbus_controller-offline_skip_updates" aria-hidden="true"></a>
...
<a id="modbus_custom_command" aria-hidden="true"></a>
...
<a id="modbus_register_count" aria-hidden="true"></a>
...
<a id="modbusseealso" aria-hidden="true"></a>

<a id="modbus_controller-automations" aria-hidden="true"></a>

## Automation

<a id="modbus_controller-on_command_sent" aria-hidden="true"></a>
...
<a id="modbus_controller-on_online" aria-hidden="true"></a>
...
<a id="modbus_controller-on_offline" aria-hidden="true"></a>
