...
<a id="sml-platform" aria-hidden="true"></a>
...
<a id="sml-on-data" aria-hidden="true"></a>
...
<Img src="sml-log.png" alt="Image" caption="OBIS information in the log of the `SML` component" class="align-center" width="100.0%" />
