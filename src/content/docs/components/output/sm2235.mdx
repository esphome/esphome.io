...
<a id="sm2235-component" aria-hidden="true"></a>
...
<a id="sm2235-output" aria-hidden="true"></a>
...
- <ApiRef text="output/sm2235_output_component.h" path="output/sm2235_output_component.h" />
