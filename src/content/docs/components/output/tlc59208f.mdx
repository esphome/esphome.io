...
<a id="tlc59208f-component" aria-hidden="true"></a>
...
<a id="tlc59208f-output" aria-hidden="true"></a>
...
<Img src="tlc59208f-full.jpg" alt="Image" caption="Sample application of a TLC59208F 8-Channel PWM Driver." class="align-center" width="75.0%" />
...
- <ApiRef text="tlc59208f/tlc59208f_output.h" path="tlc59208f/tlc59208f_output.h" />
