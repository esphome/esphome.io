...
- **value_type** (*Optional*, default `U_WORD`): data type of the modbus register data. The default data type for modbus is a 16 bit integer in big endian format (MSB first).
