...
&lt;Img src="sigma-delta-example.png" alt="Image" caption="Comparison between a *Slow PWM* with a period of 100s and a *sigma-delta output* with an update interval of 1s" class="align-center" width="65.0%" /&gt;
