...
<a id="sm16716-component" aria-hidden="true"></a>
...
<a id="sm16716-output" aria-hidden="true"></a>
...
- <ApiRef text="output/sm16716_output_component.h" path="output/sm16716_output_component.h" />
