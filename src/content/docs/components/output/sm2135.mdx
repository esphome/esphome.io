...
<a id="sm2135-component" aria-hidden="true"></a>
...
<a id="sm2135-output" aria-hidden="true"></a>
...
- <ApiRef text="output/sm2135_output_component.h" path="output/sm2135_output_component.h" />
