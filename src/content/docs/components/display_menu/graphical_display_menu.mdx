...
<a id="graphical_display_menu" aria-hidden="true"></a>
...
<Img src="graphical_display_menu.png" alt="Image" class="align-center" width="60.0%" />
...
<a id="drawing_modes" aria-hidden="true"></a>
