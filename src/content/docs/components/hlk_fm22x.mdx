...
<Image src={hlkFm225Img} layout="constrained" alt="HLK-FM225 Face Recognition Module" />

<Image src={hlkFm223Img} layout="constrained" alt="HLK-FM223 Face Recognition Module" />
...
- All options from [Binary Sensor](#binary-sensor).
...
- All options from [Text Sensor](#text-sensor).
