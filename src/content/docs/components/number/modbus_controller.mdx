...
- **write_lambda** (*Optional*, [lambda](/automations/templates#config-lambda)): Lambda called before send.
  ...
  - `return <FLOATING_POINT_NUMBER>;` the new value for the sensor.
  - `<fill payload with data> and return <anything>;` if the payload is added from the lambda then these 16 bit words will be sent
...
- [Modbus Controller](/components/sensor/modbus_controller/)
- [Modbus Controller](/components/binary_sensor/modbus_controller/)
- [Modbus Controller](/components/output/modbus_controller/)
- [Modbus Controller](/components/switch/modbus_controller/)
- [Modbus Controller](/components/select/modbus_controller/)
- [Modbus Controller](/components/text_sensor/modbus_controller/)
