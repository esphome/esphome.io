...
change the UUID to something unique. You can generate a random UUID using an [online UUID generator](https://www.uuidgenerator.net/).
...
![Image](./images/esp32_ble_beacon-ibeacon.png)

## See Also

- [Esp32 Ble Tracker](/esp32_ble_tracker/)
- [Ble Presence](/binary_sensor/ble_presence/)
- 
