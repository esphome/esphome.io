...
<a id="esphome-configuration_variables" aria-hidden="true"></a>
...
<a id="esphome-on_boot" aria-hidden="true"></a>
...
<a id="esphome-on_shutdown" aria-hidden="true"></a>

## `on_shutdown`

This automation will be triggered when the ESP is about to shut down. Shutting down is usually caused by
too many WiFi/MQTT connection attempts, Over-The-Air updates being applied or through the [deep_sleep/](/deep_sleep/).
...
<a id="esphome-on_loop" aria-hidden="true"></a>
...
<a id="esphome-platformio_options" aria-hidden="true"></a>
...
<a id="esphome-environment_variables" aria-hidden="true"></a>
...
<a id="esphome-includes" aria-hidden="true"></a>
...
<a id="esphome-libraries" aria-hidden="true"></a>
...
<a id="preferences-flash_write_interval" aria-hidden="true"></a>
...
<a id="esphome-changing_node_name" aria-hidden="true"></a>
...
<a id="esphome-mac_suffix" aria-hidden="true"></a>
...
<a id="esphome-creators_project" aria-hidden="true"></a>
...
<a id="esphome-min_version" aria-hidden="true"></a>
...
<a id="esphome-area" aria-hidden="true"></a>
...
<a id="esphome-devices" aria-hidden="true"></a>
