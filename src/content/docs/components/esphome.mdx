...
- **toolchain** (*Optional*, [Toolchain](#esphome-toolchain)): Toolchain used to build the firmware.
...
<span id="esphome-toolchain"></span>
...
If no toolchain is specified, ESPHome defaults to `platformio`.
