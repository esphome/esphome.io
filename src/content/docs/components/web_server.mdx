...
<Image src={webServerImg} layout="constrained" alt="" />

<Image src={webServerV2Img} layout="constrained" alt="" />

<Image src={webServerV3Img} layout="constrained" alt="" />
...
<Image src={tabHeaderExpandControlsExpandedImg} layout="constrained" alt="" />

<Image src={tabHeaderExpandLogsExpandedImg} layout="constrained" alt="" />
