...
<Img src="web_server.png" alt="Image" caption="Web server version 1" class="align-center" width="86.0%" />

<Img src="web_server-v2.png" alt="Image" caption="Web server version 2" class="align-center" width="86.0%" />

<Img src="web_server-v3.png" alt="Image" caption="Web server version 3" class="align-center" width="86.0%" />
...
<a id="config-webserver-version-3-options" aria-hidden="true"></a>

## Version 3 features

<a id="config-webserver-sorting" aria-hidden="true"></a>
...
<a id="config-webserver-grouping" aria-hidden="true"></a>
...
<Img src="number-slider-popup.png" alt="Image" class="align-left" width="100.0%" />
...
<Img src="number-slider-popup-input-field.png" alt="Image" class="align-left" width="100.0%" />

### Expand Controls and Logs

<Img src="tab-header-expand-cloapsed.png" alt="Image" class="align-left" width="100.0%" />
...
<Img src="tab-header-expand-controls-expanded.png" alt="Image" caption="Expanded Controls" class="align-center" width="100.0%" />

<Img src="tab-header-expand-logs-expanded.png" alt="Image" caption="Expanded Logs" class="align-center" width="100.0%" />

### Sensor value graph

<Img src="sensor-history-graph.png" alt="Image" class="align-left" width="100.0%" />
