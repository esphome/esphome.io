...
![Image](./images/web_server.png)

![Image](./images/web_server-v2.png)

![Image](./images/web_server-v3.png)
...
![Image](./images/number-slider-popup.png)
...
![Image](./images/number-slider-popup-input-field.png)

### Expand Controls and Logs

![Image](./images/tab-header-expand-cloapsed.png)
...
![Image](./images/tab-header-expand-controls-expanded.png)

![Image](./images/tab-header-expand-logs-expanded.png)

### Sensor value graph

![Image](./images/sensor-history-graph.png)
