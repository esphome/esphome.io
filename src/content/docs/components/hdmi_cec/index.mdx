...
**Note**: Probably, the requirement for a diode on the UART output can be dropped on some of the newer microcontrollers,
...
the pin mode can probably be overwritten. This needs further testing.
