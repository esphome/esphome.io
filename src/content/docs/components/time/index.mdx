...
<a id="base_time_config" aria-hidden="true"></a>
...
<a id="time-has_time_condition" aria-hidden="true"></a>
...
<a id="time-on_time" aria-hidden="true"></a>
...
<a id="time-on_time_sync" aria-hidden="true"></a>
