...
<a id="nextion_switch" aria-hidden="true"></a>
...
<a id="switch-nextion-publish_action" aria-hidden="true"></a>
...
<a id="nextion_switch_lambda_calls" aria-hidden="true"></a>
...
<a id="nextion_switch_set_state" aria-hidden="true"></a>
...
<a id="nextion_switch_update" aria-hidden="true"></a>

- `update()`  : Poll from the Nextion

<a id="nextion_switch_settings" aria-hidden="true"></a>
...
<a id="nextion_switch_how_things_update" aria-hidden="true"></a>
...
<a id="nextion_custom_switch_protocol" aria-hidden="true"></a>
