  ...
  filter:
    mac_address:
      ...
      - value: 00:11:22:33:44:56
        public: false
      - value: 00:11:22:33:44:57
      - value: 00:11:22:33:44:58
      - value: 00:11:22:33:44:59
```
...
> [!NOTE]
> A `mac_address` list is applied at the scanning stage, so the board only processes advertisement packets from approved devices. This ensures that incoming BLE advertisements are limited to explicitly authorized devices, improving security and reducing unnecessary processing.
