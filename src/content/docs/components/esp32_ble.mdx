...
- **max_key_size** (*Optional*, integer): Maximum encryption key size to support. Leave unspecified to use the ESP32 default unless your device needs special handling.

  - Range: 7 to 16

- **min_key_size** (*Optional*, integer): Minimum encryption key size requirement from peer. Leave unspecified to use the ESP32 default unless your device needs special handling.
