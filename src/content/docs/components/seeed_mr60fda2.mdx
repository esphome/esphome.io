...
<Img src="seeed_mr60fda2.jpg" alt="Image" caption="Seeed Studio MR60FDA2 60GHz mmWave Fall Detection Sensor Kit with XIAO ESP32C6" class="align-center" width="50.0%" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [seeed_mr60fda2/](/seeed_mr60fda2/) component if you need multiple components.
