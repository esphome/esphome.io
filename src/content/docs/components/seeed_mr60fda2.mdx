...
<Image src="/images/seeed_mr60fda2.jpg" width={300} height={300} layout="constrained" alt="" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Seeed Mr60Fda2](/seeed_mr60fda2/) component if you need multiple components.
