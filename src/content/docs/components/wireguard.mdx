...
>
> See [time/](/time/) to setup a time source
...
<a id="wireguard-address" aria-hidden="true"></a>
...
- **address** (**Required**, IPv4 address): The local VPN address of the device.
  ...
  to copy this value to the `use_address` parameter of the [wifi/](/wifi/).
...
- **netmask** (*Optional*, IPv4 address): The netmask for the configured address.
  ...
  expected to transit through the VPN link (e.g. with [mqtt/](/mqtt/) to a
  remote MQTT broker).
...
- **require_connection_to_proceed** (*Optional*, boolean): Set to `true` to
  ...
  [mqtt/](/mqtt/) to reach a remote broker you may experience boot freeze just
...
<a id="wireguard-static-routes" aria-hidden="true"></a>
...
<a id="wireguard-sensors" aria-hidden="true"></a>
...
<a id="wireguard-actions" aria-hidden="true"></a>
...
<a id="wireguard-conditions" aria-hidden="true"></a>
...
<a id="wireguard-installation" aria-hidden="true"></a>
...
> the `use_address` parameter of the [wifi/](/wifi/) to the value
