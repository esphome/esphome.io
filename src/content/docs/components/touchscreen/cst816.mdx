...
<Img src="cst816.jpg" alt="Image" caption="cst816t touchscreen on T-Display S3 AMOLED" class="align-center" width="50.0%" />
...
- <ApiRef text="cst816/touchscreen/cst816_touchscreen.h" path="cst816/touchscreen/cst816_touchscreen.h" />
