...
<Img src="esp32_s3_box_3.png" alt="Image" caption="gt911 touchscreen on ESP32-S3-BOX-3" class="align-center" width="50.0%" />
...
- <ApiRef text="gt911/touchscreen/gt911.h" path="gt911/touchscreen/gt911.h" />
- <ApiRef text="gt911/binary_sensor/gt911_button.h" path="gt911/binary_sensor/gt911_button.h" />
