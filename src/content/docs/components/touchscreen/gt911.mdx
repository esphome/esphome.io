...
If the touchscreen interrupt line runs through an IO Expander rather than directly to an ESP GPIO this will allow for configuration of touchscreen 
at boot but transitions to touch detection polling.
