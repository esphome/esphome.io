...
<Img src="indicator.jpg" alt="Image" caption="ft5x06 touchscreen in Seeed Studio Sensecap Indicator." class="align-center" width="50.0%" />
...
- <ApiRef text="ft5x06/touchscreen/ft5x06_touchscreen.h" path="ft5x06/touchscreen/ft5x06_touchscreen.h" />
