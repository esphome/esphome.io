...
<a id="esp32_hosted-configuration_variables" aria-hidden="true"></a>
...
You can update the firmware on your ESP32 co-processor using the [update/esp32_hosted/](/update/esp32_hosted/)
...
- [network/](/network/)
- [ethernet/](/ethernet/)
- [update/esp32_hosted/](/update/esp32_hosted/)
