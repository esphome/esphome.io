...
- **code** (*Optional*, list of 13 or 14 bytes, [templatable](/automations/templates)): The raw payload. The 14th byte is the checksum and is calculated and appended automatically if omitted. Cannot be combined with any of the friendly fields below.
