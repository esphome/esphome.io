...
> [!WARNING]
> If you are using the [logger/](/logger/) make sure you are not using the same pins for `TX` and `RX` or
...
<Img src="sim800l-full.jpg" alt="Image" class="align-center" width="60.0%" />
...
<a id="sim800l-on_sms_received" aria-hidden="true"></a>
...
<a id="sim800l-on_incoming_call" aria-hidden="true"></a>
...
<a id="sim800l-send_sms_action" aria-hidden="true"></a>
...
<a id="sim800l-dial_action" aria-hidden="true"></a>
