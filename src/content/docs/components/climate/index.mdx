...
<Img src="climate-ui.png" alt="Image" caption="Climate Device UI in Home Assistant." class="align-center" width="60.0%" />
...
<a id="config-climate" aria-hidden="true"></a>
...
<a id="climate-control_action" aria-hidden="true"></a>
...
<a id="climate-lambda_calls" aria-hidden="true"></a>
...
<a id="climate-on_state_trigger" aria-hidden="true"></a>
...
<a id="climate-on_control_trigger" aria-hidden="true"></a>
