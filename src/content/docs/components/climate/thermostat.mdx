...
physical thermostat. Its operation is similar to the [Bang-Bang](/components/bang_bang/) controller; a sensor measures a value
...
When configured for both heating and cooling, it is essentially two [Bang-Bang](/components/bang_bang/) controllers in one; it
...
Please see the [Bang-Bang](/components/bang_bang/) component's documentation for a detailed comparison of these two components.

## See Also

- [Climate](/components/climate/)
- [Sensor](/components/sensor/)
- [Bang-Bang](/components/bang_bang/)
