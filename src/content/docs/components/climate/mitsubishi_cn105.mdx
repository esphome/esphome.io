...
Older configurations that define Mitsubishi CN105 UART/protocol options inside the `climate:` entry (`platform: mitsubishi_cn105`) are still accepted temporarily, but new configurations should use the top-level `mitsubishi_cn105` hub.
