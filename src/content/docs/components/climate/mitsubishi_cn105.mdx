...
- **use_fahrenheit** (*Optional*, boolean): Enable Fahrenheit temperature support. If temperatures shown in Home Assistant deviate from those on the AC unit, enable this option to apply Mitsubishi-specific mapping. Defaults to `false`.
