...
low, and medium, and uses the Turbo bit for high. Independent feature fields such as timer, Light, X-Fan, display
temperature, I-Feel, and WiFi do not change the climate state.
