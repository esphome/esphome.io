...
| ----------------------------------------- | ---------------------------------- | ----------------- |
| [Airton](#climate_ir_airton)              | `airton`                           | yes               |
| Ballu                                     | `ballu`                            | yes               |
| Coolix                                    | `coolix`                           | yes               |
| Daikin | `daikin`                           | yes |
...
<span id="climate_ir_airton"></span>
...
To expose additional functionality you shall use a switch and/or selection components with the platform `airton`: check out [Airton IR Remote Climate Switch](/components/switch/airton) and [Airton IR Remote Climate Select](/components/select/airton).
...
- <APIRef text="airton.h" path="airton/airton.h" />
