...
> [!NOTE]
> The [thermostat](/components/thermostat/) component behaves more like a common thermostat; it is
...
two key differences between the bang-bang component and the [thermostat](/components/thermostat/) component:
...
The [thermostat](/components/thermostat/) component differs in that there is hysteresis around *each* set point. For example,
...
is associated with heating while the other with cooling, and this is exactly how the [thermostat](/components/thermostat/)
...
- If you have a dual-function system (both heating and cooling), you'll almost certainly want to use the
  [thermostat](/components/thermostat/) component.
...
In all other situations, the [thermostat](/components/thermostat/) component is probably best.
