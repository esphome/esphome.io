...
<Img src="usb_pinout.png" alt="Image" caption="KZW-W002 module pinout" class="align-center" width="70.0%" />
...
<Img src="haier_pinout.jpg" alt="Image" caption="ESP32-for-Haier UART0 pinout" class="align-center" width="70.0%" />
...
<a id="haier-on_alarm_start" aria-hidden="true"></a>
...
<a id="haier-on_alarm_end" aria-hidden="true"></a>
...
<a id="haier-on_status_message" aria-hidden="true"></a>
