...
- **transmitter_id** (*Optional*, [ID](/guides/configuration-types#id)): Defined and used automatically when using [Remote Transmitter](/../remote_transmitter/) component for IR commands transmit.
...
This action toggle ac screen. Works via UART if supported or [Remote Transmitter](/../remote_transmitter/).
...
This action adjust the louver by one step. [Remote Transmitter](/../remote_transmitter/) required.
...
Below is an example of how to send FollowMe commands with the values of your sensor using the [Remote Transmitter](/../remote_transmitter/)
