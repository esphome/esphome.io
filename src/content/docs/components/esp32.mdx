...
- **Ethernet MAC:** Built-in (requires external PHY)
- **GPIO:** 34 usable pins
- **UART:** 3
- **I2C:** 2
...
include Bluetooth or Classic Bluetooth.
...
- **CPU:** RISC-V HP core @ 160 MHz + LP core @ 20 MHz
...
- **CPU:** RISC-V HP dual-core @ 400 MHz + LP core @ 40 MHz
