...
- **partitions** (*Optional*, filename or list of [partitions](#esp32-partitions)): The name of (optionally including the path to) the file containing the
  partitioning scheme to be used or a list of [partitions](#esp32-partitions) to be added to the automatically generated partition scheme.
  When no partition scheme file is specified, partitions are automatically generated based on `flash_size`.
...
The `partitions` option allows you to add partitions to the automatically generated partition table. Valid partition types and subtypes
