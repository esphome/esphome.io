...
- **partitions** (*Optional*, filename or list of partitions): The name of (optionally including the path to) the file containing the
  partitioning scheme to be used or a list of partitions to be added to the automatically generated partition scheme. See [Partitions](#esp32-partitions).
