...
The `es8388` select allows you to control the `dac output` and the `adc input_mic` of your [es8388/](/es8388/).
...
- **es8388_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [es8388/](/es8388/) component.
