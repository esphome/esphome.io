...
<ImgTable items={[
  ...
  ["MQ Gas Sensors", "/components/sensor/mq_gas_sensors/", "mq-gas-sensor.jpg", "Gas concentration"],
...
<ImgTable items={[
  ...
  ["Xiaomi Body Scale", "/components/sensor/xiaomi_body_scale/", "xiaomi_body_scale.jpg", "S200, S400"],
