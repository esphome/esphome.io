...
Platforms which specifically support or extend the [index](/components/one_wire/index/), allowing communication with
...
Platforms which specifically support or extend the [index](/components/canbus/index/), allowing communication with
CAN-based devices.
...
<ImgTable items={[
  ["Infrared Core", "/components/infrared/index/", "remote.svg", "dark-invert"],
...
<ImgTable items={[
  ["Water Heater Core", "/components/water_heater/index/", "water_heater.svg"],
