...
<Img src="at581x.png" alt="Image" caption="AirTouch AT581x Radar / presence detection sensor" class="align-center" width="75%" />
...
<a id="at581x-component" aria-hidden="true"></a>
...
<a id="at581x-binary_sensor" aria-hidden="true"></a>
...
<a id="at581x-switch" aria-hidden="true"></a>
...
<a id="at581x-actions" aria-hidden="true"></a>

## Actions

<a id="at581x-action_settings" aria-hidden="true"></a>
