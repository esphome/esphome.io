...
- **passkey** (*Optional*, int): A fixed passkey for notification or numeric comparison. Range: 1 to 999999. Useful if there is no display. Can be empty for random passkey.
