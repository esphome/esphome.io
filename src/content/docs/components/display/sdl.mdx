...
The `sdl` display platform allows you to use create an ESPHome display on a desktop system running Linux or MacOS, relying on [Host Platform](/components/host).
