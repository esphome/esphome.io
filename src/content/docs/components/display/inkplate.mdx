...
title: "Inkplate 5, 6, 10, 6 Plus and 4 Tempera"
---

import { Image } from 'astro:assets';
import Figure from '@components/Figure.astro';

All-in-one e-paper display `Inkplate 5`, `Inkplate 6`, `Inkplate 10`, `Inkplate 6 Plus` and `Inkplate 4 Tempera`.

The Inkplate 5, 6, 10, 6 Plus and 4 Tempera are powerful, Wi-Fi enabled ESP32 based six-inch e-paper displays -
...
The Inkplate 4 Tempera has the same GPIO expander as the models 5, 6 v2 and 10.

Minimal display-only configuration:
...
It has some additional sensors supported by ESPHome for climate and gesture that can be configured as below:
