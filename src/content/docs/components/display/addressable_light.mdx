...
The display requires that an  component, such as
[Fastled](/components/light/fastled/) or [Neopixelbus](/components/light/neopixelbus/), be defined.

<Image src="/images/addressable_light.jpg" width={250} height={253} layout="constrained" alt="" />
...
<Image src={addressableLightPixelMapDefaultImg} layout="constrained" alt="" />
...
<Image src={addressableLightPixelMap8x32Img} layout="constrained" alt="" />
