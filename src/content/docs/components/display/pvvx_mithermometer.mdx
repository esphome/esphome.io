...
<Img src="xiaomi_lywsd03mmc.jpg" alt="Image" caption="Xiaomi LYWSD03MMC." class="align-center" width="75.0%" />
...
<a id="display-pvvx_mithermometer_lambda" aria-hidden="true"></a>
