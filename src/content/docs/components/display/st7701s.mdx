...
> [!CAUTION]
> This component has been made redundant since the ST7701S is now supported by the [Mipi Rgb](/components/mipi_rgb/).
...
<Image src="/images/indicator.jpg" width={294} height={300} layout="constrained" alt="" />
