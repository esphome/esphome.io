...
<a id="st7701s" aria-hidden="true"></a>
...
> [!WARNING]
> This component has been made redundant since the ST7701S is now supported by the [mipi_rgb](/mipi_rgb/).
...
<Img src="indicator.jpg" alt="Image" caption="Sensecap Indicator display" class="align-center" width="75.0%" />
...
- [index/](/)
- <ApiRef text="st7701s/st7701s.h" path="st7701s/st7701s.h" />
