...
| -------------------------- | ------------ | ------------------- | ------------------------------------------------------------------------- |
| WAVESHARE-10.1-DSI-TOUCH-A | Waveshare    | 800x1280            | [Waveshare product page](https://www.waveshare.com/wiki/10.1-DSI-TOUCH-A) |
| WAVESHARE-8-DSI-TOUCH-A    | Waveshare    | 800x1280            | [Waveshare product page](https://www.waveshare.com/wiki/8-DSI-TOUCH-A)    |
| WAVESHARE-7-DSI-TOUCH-A    | Waveshare    | 720x1280            | [Waveshare product page](https://www.waveshare.com/wiki/7-DSI-TOUCH-A)    |
| WAVESHARE-4-DSI-TOUCH-C    | Waveshare    | 720x720 (round)     | [Waveshare product page](https://www.waveshare.com/wiki/4-DSI-TOUCH-C)    |
| WAVESHARE-3.4-DSI-TOUCH-C  | Waveshare    | 800x800 (round)     | [Waveshare product page](https://www.waveshare.com/wiki/3.4-DSI-TOUCH-C)  |
...
| ---------------------- | -------------- | --------------------------------------------------------------------------------------------------- |
| JC1060P470             | Guition        | [AliExpress product page](https://aliexpress.com/item/1005008328088576.html)                        |
| JC4880P443             | Guition        | [AliExpress product page](https://aliexpress.com/item/1005009618259341.html)                        |
| JC8012P4A1             | Guition        | [AliExpress product page](https://aliexpress.com/item/1005008789890066.html)                        |
| M5STACK-TAB5           | M5Stack        | [M5Stack product page](https://shop.m5stack.com/products/m5stack-tab5-iot-development-kit-esp32-p4) |
| M5STACK-TAB5-V2        | M5Stack        | [M5Stack product page](https://shop.m5stack.com/products/m5stack-tab5-iot-development-kit-esp32-p4) |
| WAVESHARE-P4-NANO-10.1 | Waveshare      | [Waveshare product page](https://www.waveshare.com/esp32-p4-nano.htm?sku=29031)                     |
| WAVESHARE-P4-86-PANEL  | Waveshare      | [Waveshare product page](https://www.waveshare.com/esp32-p4-wifi6-touch-lcd-4b.htm?sku=31570)       |
| WAVESHARE-ESP32-P4-WIFI6-TOUCH-LCD-7B   | Waveshare | [Waveshare product page](https://www.waveshare.com/wiki/ESP32-P4-WIFI6-Touch-LCD-7B)    |
| WAVESHARE-ESP32-P4-WIFI6-TOUCH-LCD-3.4C | Waveshare | [Waveshare product page](https://www.waveshare.com/wiki/ESP32-P4-WIFI6-Touch-LCD-3.4C)  |
| WAVESHARE-ESP32-P4-WIFI6-TOUCH-LCD-4C   | Waveshare | [Waveshare product page](https://www.waveshare.com/wiki/ESP32-P4-WIFI6-Touch-LCD-4C)    |
