...
These are standalone display panels incorporating a driver chip and display panel. Transform, rotation or other
...
| -------------------------- | ------------ | --------------------|--------------------------------------------------------------------------------------------------- |
| WAVESHARE-10.1-DSI-TOUCH-A | Waveshare    | x:800 y:1280        | [https://www.waveshare.com/wiki/10.1-DSI-TOUCH-A](https://www.waveshare.com/wiki/10.1-DSI-TOUCH-A) |
| WAVESHARE-8-DSI-TOUCH-A    | Waveshare    | x:800 y:1280        | [https://www.waveshare.com/wiki/8-DSI-TOUCH-A](https://www.waveshare.com/wiki/8-DSI-TOUCH-A)       |
| WAVESHARE-7-DSI-TOUCH-A    | Waveshare    | x:720 y:1280        | [https://www.waveshare.com/wiki/7-DSI-TOUCH-A](https://www.waveshare.com/wiki/7-DSI-TOUCH-A)       |
| WAVESHARE-4-DSI-TOUCH-C    | Waveshare    | x:720 y:720 (round) | [https://www.waveshare.com/wiki/4-DSI-TOUCH-C](https://www.waveshare.com/wiki/4-DSI-TOUCH-C)       |
| WAVESHARE-3.4-DSI-TOUCH-C  | Waveshare    | x:800 y:800 (round) | [https://www.waveshare.com/wiki/3.4-DSI-TOUCH-C](https://www.waveshare.com/wiki/3.4-DSI-TOUCH-C)   |
