...
is *only* for the digit "matrix" display, for the 7 segment display see [max7219/](/max7219/).

<Img src="max7219digit.png" alt="Image" caption="MAX7219 Digit Display." class="align-center" width="75.0%" />
...
<a id="display-max7219digit_lambda" aria-hidden="true"></a>
