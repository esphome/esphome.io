...
is *only* for the digit "matrix" display, for the 7 segment display see [Max7219](/components/display/max7219digit/).

<Image src={max7219digitImg} layout="constrained" alt="" />
