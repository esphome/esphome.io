...
<Figure
  src={ht16k33_7seg_ref}
  caption="A picture showing the segments of a seven segment display"
  layout="constrained"
  alt=""
/>

<Figure
  src={ht16k33_14seg_ref}
  caption="A picture showing the segments of a 14 segment display"
  layout="constrained"
  alt=""
/>
