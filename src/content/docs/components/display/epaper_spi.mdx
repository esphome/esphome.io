...
| ---------------------- |--------------| ---------------------------------------------------------------------------------------------------------------------------- |
| Seeed-reTerminal-E1002 | Seeed Studio | 7.3" 6-color e-paper (800x480, Spectra-E6). [https://www.seeedstudio.com/reTerminal-E1002-p-6533.html](https://www.seeedstudio.com/reTerminal-E1002-p-6533.html) |
...
- **enable_pin** (*Optional*, [Pin Schema](/guides/configuration-types#pin-schema)): The display enable pin for boards that have one (e.g. reTerminal E1004). Predefined for integrated boards that require it.
