...
| IT8951E                | ITE          | [https://www.ite.com.tw/en/product/cate5/IT8951) |
...
| M5Paper                | M5Stack      | 540 x 960 @4.7" e-ink screen, supporting 16-level grayscale display [Doc](https://docs.m5stack.com/en/core/m5paper)          |
...
- **dc_pin** (**Required if needed**, [Pin Schema](/guides/configuration-types#pin-schema)): The DC pin. Predefined for integrated boards.
