...
<a id="qspi_dbi" aria-hidden="true"></a>
...
<Img src="t4-s3.jpg" alt="Image" caption="Lilygo T4-S3" class="align-center" width="75.0%" />

<Img src="t-display-amoled.jpg" alt="Image" caption="Lilygo T-Display S3 AMOLED" class="align-center" width="75.0%" />
