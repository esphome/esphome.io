...
> [!CAUTION]
> This component has been made redundant since this class of displays is now supported by the [Mipi Spi](/components/mipi_spi/)
...
<Image src="/images/t4-s3.jpg" width={300} height={300} layout="constrained" alt="" />

<Image src={tDisplayAmoledImg} layout="constrained" alt="" />
