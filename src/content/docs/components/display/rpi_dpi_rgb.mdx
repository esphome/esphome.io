...
> [!CAUTION]
> This component has been made redundant since this class of displays is now supported by the [Mipi Rgb](/components/mipi_rgb/)
...
<Image src="/images/waveshare_touch-s3.jpg" width={293} height={220} layout="constrained" alt="" />
