...
- Serial displays like [nextion/](/nextion/) that have their own processors for graphics rendering.
...
<a id="display-configuration" aria-hidden="true"></a>
...
<a id="display-engine" aria-hidden="true"></a>
...
<a id="display-static_text" aria-hidden="true"></a>
...
<a id="display-printf" aria-hidden="true"></a>
...
<a id="display-strftime" aria-hidden="true"></a>
...
<a id="clipping" aria-hidden="true"></a>
...
<a id="config-color" aria-hidden="true"></a>
...
<a id="display-pages" aria-hidden="true"></a>
...
<a id="display-is_displaying_page-condition" aria-hidden="true"></a>
...
<a id="display-on_page_change-trigger" aria-hidden="true"></a>
...
<Img src="test_card.jpg" alt="Image" class="align-center" width="50.0%" />
