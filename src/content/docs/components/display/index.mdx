...
- Character displays like [7-Segment displays](/components/max7219/) or
  [LCD displays](/components/lcd_display/).

- Serial displays like [Nextion](/components/nextion/) that have their own processors for graphics rendering.
- Graphical displays with fully addressable pixels, such as
  [SPI interfaced LCDs](/components/mipi_spi/),
  [E-Paper](/components/waveshare_epaper/),
  [HUB75 LED matrices](/components/hub75/),
  and [OLED](/components/ssd1306/).
