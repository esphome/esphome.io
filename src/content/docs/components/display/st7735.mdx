...
<Image src="/images/st7735.jpg" width={300} height={225} layout="constrained" alt="" />

> [!CAUTION]
> This component has been made redundant since the ST7735 is now supported by the [Mipi Spi](/components/mipi_spi/).
