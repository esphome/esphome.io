...
<Img src="max7219-full.jpg" alt="Image" caption="MAX7219 7-Segment Display." class="align-center" width="75.0%" />
...
<a id="display-max7219_lambda" aria-hidden="true"></a>
...
<a id="display-max7219_characters" aria-hidden="true"></a>
