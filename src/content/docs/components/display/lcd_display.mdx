...
<Img src="lcd-hello_world.jpg" alt="Image" class="align-center" width="60.0%" />
...
<a id="lcd-pcf8574" aria-hidden="true"></a>
...
<Img src="lcd-pcf8574.jpg" alt="Image" caption="LCD Display with a PCF8574 board attached on the back" class="align-center" width="75.0%" />
...
<a id="lcd-gpio" aria-hidden="true"></a>
...
<Img src="lcd_gpio.svg" alt="Image" caption="LCD Display GPIO pinout" class="align-center" width="75.0%" />
...
<a id="display-lcd_lambda" aria-hidden="true"></a>
