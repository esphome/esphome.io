...
> [!WARNING]
> If you are using the [logger/](/logger/) make sure you disable the uart logging with the
> `baud_rate: 0` option.

<Img src="rf_bridge-full.jpg" alt="Image" caption="Sonoff RF Bridge 433 (version R1 or R2 V1.0)" class="align-center" width="50.0%" />
...
<a id="rf_bridge-on_code_received" aria-hidden="true"></a>
...
<a id="rf_bridge-send_code_action" aria-hidden="true"></a>
...
<a id="rf_bridge-beep_action" aria-hidden="true"></a>
...
<a id="rf_bridge-learn_action" aria-hidden="true"></a>
...
<a id="rf_bridge-send_raw_action" aria-hidden="true"></a>
...
<a id="rf_bridge-on_advanced_code_received" aria-hidden="true"></a>
...
<a id="rf_bridge-send_advanced_code_action" aria-hidden="true"></a>
...
<a id="rf_bridge-start_advanced_sniffing_action" aria-hidden="true"></a>
...
<a id="rf_bridge-stop_advanced_sniffing_action" aria-hidden="true"></a>
...
<a id="rf_bridge-start_bucket_sniffing_action" aria-hidden="true"></a>
...
<a id="rf_bridge-restart_radio_controller" aria-hidden="true"></a>
