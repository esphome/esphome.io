...
<Img src="micronova_serial.png" alt="Image" class="align-center" width="50.0%" />

<Img src="micronova_serial_layout.png" alt="Image" class="align-center" width="50.0%" />
...
<Img src="micronova_optocouplers.png" alt="Image" caption="Optocoupler interface circuit (credit: philibertc)" class="align-center" width="100.0%" />
