...
The circuit above assumes the RX pin has an internal pullup resistor. But, the [UART](/components/uart) doesn't provide an option to activate it, so you might need to use an external pullup resistor.
