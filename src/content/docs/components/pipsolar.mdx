...
<Img src="pipsolar.jpg" alt="Image" caption="pip4048 compatible PV Inverter." class="align-center" width="50.0%" />
...
<a id="pipsolaroutput_set_level_action" aria-hidden="true"></a>
