...
![Image](./images/lvgl_main_screenshot.png)
...
For interactivity, a [Touchscreen](/components/touchscreen/index/) (capacitive highly preferred), a [Rotary Encoder](/components/sensor/rotary_encoder/) or a custom keypad made up from discrete [Binary Sensors](/components/binary_sensor/index/) can be used.
...
![Image](./images/lvgl_boxmodel.png)
