...
- **width** (*Optional*, [size](#lvgl-size)): Render width. Required with `src`; optional with `file`.
- **height** (*Optional*, [size](#lvgl-size)): Render height. Required with `src`; optional with `file`.
...
- **width** (*Optional*, [size](#lvgl-size)): Render width. Required with `src`; optional with `file` if the SVG size can be detected.
- **height** (*Optional*, [size](#lvgl-size)): Render height. Required with `src`; optional with `file` if the SVG size can be detected.
- Style options from [Style properties](/components/lvgl#lvgl-styling).
