...
- **text_outline_stroke_color** (*Optional*, [color](/components/lvgl#lvgl-color)): Color to draw an outline around the text glyphs.
- **text_outline_stroke_width** (*Optional*, int16): Set the width of the outline in pixels.
- **text_outline_stroke_opa** (*Optional*, [opacity](/components/lvgl#lvgl-opacity)): Opacity of the outline drawnd around the text glyphs.
