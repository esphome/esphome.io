...
This component may also be configured in access point (AP) mode alongside
[Ethernet](/components/ethernet/), so that clients connecting to the AP reach the network through the Ethernet
connection.
