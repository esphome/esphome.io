...
Some components such as [Captive Portal](/captive_portal/), [Improv Serial](/improv_serial/) and
[Esp32 Improv](/esp32_improv/) enable the user to send and save Wi-Fi credentials to the device. Beginning in 2022.11.0,
...
- [Wifi Signal](/sensor/wifi_signal/)
- [Network](/network/)
