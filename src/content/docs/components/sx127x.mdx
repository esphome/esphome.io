...
<a id="sx127x" aria-hidden="true"></a>
...
<Img src="sx127x-full.png" alt="Image" class="align-center" width="50.0%" />
...
> after calling `configure`. See <ApiRef text="sx127x/sx127x.h" path="sx127x/sx127x.h" />.
