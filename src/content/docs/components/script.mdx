...
<a id="script-parameters" aria-hidden="true"></a>
...
<a id="script-execute_action" aria-hidden="true"></a>
...
<a id="script-stop_action" aria-hidden="true"></a>
...
<a id="script-wait_action" aria-hidden="true"></a>
...
<a id="script-is_running_condition" aria-hidden="true"></a>
