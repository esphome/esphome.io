...
<a id="config-button" aria-hidden="true"></a>
...
<a id="button-on_press" aria-hidden="true"></a>
...
<a id="button-press_action" aria-hidden="true"></a>
...
<a id="button-lambda_calls" aria-hidden="true"></a>
