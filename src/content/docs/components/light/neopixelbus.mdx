...
>
> For clockless lights, you can use [esp32_rmt_led_strip/](/esp32_rmt_led_strip/), and for SPI LEDs see [spi_led_strip/](/spi_led_strip/).
...
It is very similar to the [fastled/](/fastled/) platform.
...
<a id="neopixelbus-methods" aria-hidden="true"></a>
