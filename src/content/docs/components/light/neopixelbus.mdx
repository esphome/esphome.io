...
>
> For clockless lights, you can use [Esp32 Rmt Led Strip](/components/esp32_rmt_led_strip/), and for SPI LEDs see [Spi Led Strip](/components/spi_led_strip/).
...
It is very similar to the [Fastled](/components/fastled/) platform.
