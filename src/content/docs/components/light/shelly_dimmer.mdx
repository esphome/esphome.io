...
A detailed analysis of the Shelly Dimmer 2 hardware is given on[https://github.com/arendst/Tasmota/issues/6914](https://github.com/arendst/Tasmota/issues/6914).
...
<Img src="shellydimmer2.jpg" alt="Image" class="align-center" width="40.0%" />
