...
> [!WARNING]
> FastLED does **not** work as expected with Arduino 3 or newer for ESP8266. For now, you can either downgrade the arduino version or use [neopixelbus/](/neopixelbus/).
>
> ```yaml
> esp8266:
>   framework:
...
>
> - [https://github.com/FastLED/FastLED/issues/1322](https://github.com/FastLED/FastLED/issues/1322)
> - [https://github.com/FastLED/FastLED/issues/1264](https://github.com/FastLED/FastLED/issues/1264)

> [!WARNING]
> FastLED does **not** work with ESP-IDF.
>
> For addressable lights, you can use [esp32_rmt_led_strip/](/esp32_rmt_led_strip/) or for SPI LEDs see [spi_led_strip/](/spi_led_strip/)..

<a id="fastled-clockless" aria-hidden="true"></a>
...
<Img src="fastled_clockless-ui.png" alt="Image" class="align-center" width="60.0%" />
...
<a id="fastled_clockless-chipsets" aria-hidden="true"></a>
...
<a id="fastled-spi" aria-hidden="true"></a>
...
<Img src="fastled_spi-ui.png" alt="Image" class="align-center" width="60.0%" />
...
<a id="fastled_spi-chipsets" aria-hidden="true"></a>
