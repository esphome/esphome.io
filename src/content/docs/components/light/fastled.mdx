...
> [!CAUTION]
> FastLED does **not** work as expected with Arduino 3 or newer for ESP8266. For now, you can either downgrade the arduino version or use [Neopixelbus](/components/neopixelbus/).
>
> ```yaml
> esp8266:
>   framework:
...
>
> For addressable lights, you can use [Esp32 Rmt Led Strip](/components/esp32_rmt_led_strip/) or for SPI LEDs see [Spi Led Strip](/components/spi_led_strip/)..
