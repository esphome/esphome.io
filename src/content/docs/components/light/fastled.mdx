...
For addressable lights, you can use [Esp32 Rmt Led Strip](/esp32_rmt_led_strip/) or for SPI LEDs see [Spi Led Strip](/spi_led_strip/)..
:::
...
![Image](./images/fastled_clockless-ui.png)
...
![Image](./images/fastled_spi-ui.png)
...
- [Spi Led Strip](/components/light/spi_led_strip/)
