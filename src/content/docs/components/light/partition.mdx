...
(like [Fastled](/components/fastled/) or [Neopixelbus](/components/neopixelbus/)) and/or individual lights (like [Rgb](/components/rgb/)) into a single addressable light.
