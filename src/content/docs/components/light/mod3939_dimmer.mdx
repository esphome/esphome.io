...
There are two types of them, supporting either 1- or 2- light channels. The devices are sold under different marketing names such as 
OXT, Smart Best, Himojo, HaveDeer, GIRIER, RSH, AVATTO which seem compatible as well but have not been tested... All of them look identical
and have same dimensions 39.2×39.2×18mm, thus it is very very likely they are all using same hardware design and protocol. Hence the component
name, "Mdoule 39x39", as their dimension is the property they share most common.
