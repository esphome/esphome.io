---
description: "Instructions for setting up an 39.2*39.2*18mm module dimmer light."
title: "Mdoule 39x39 Dimmer"
---

import { Image } from 'astro:assets';
import mod3939UiImg from './images/mod3939_dimmer.jpg';

"Mdoule 39x39" dimmers are a generic type of in-wall, brightness-only light dimming devices sold with Tuya-Smart application support,
...
as well but have not been tested... All of them look identical and have same dimensions 39.2×39.2×18mm, thus it is very very likely they are
all using same hardware design and protocol. Hence the component name, "Mdoule 39x39", as their dimension is the property they share most common.
...
The UART needs only `tx_pin`, which is usually `GPIO11` on these devices. The physical switch connects to `GPIO08` for CH1 and `GPIO09` for CH2.
