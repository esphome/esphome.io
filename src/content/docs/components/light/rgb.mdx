...
<Img src="rgb-strip.jpg" alt="Image" caption="Example of an RGB LED strip that can be used with this component." class="align-center" width="75.0%" />

<Img src="rgb-ui.png" alt="Image" class="align-center" width="40.0%" />
...
<Img src="rgb-detail.jpg" alt="Image" class="align-center" width="75.0%" />
