...
<a id="pn532-component" aria-hidden="true"></a>
...
<Img src="pn532-full.jpg" alt="Image" class="align-center" width="60.0%" />
...
<Img src="pn532-spi.jpg" alt="Image" caption="Example for hooking up the PN532 via SPI. Notice the position of the two switches on the right." class="align-center" width="80.0%" />

<a id="pn532-on_tag" aria-hidden="true"></a>
...
<a id="pn532-on_tag_removed" aria-hidden="true"></a>
...
<a id="pn532-tag" aria-hidden="true"></a>
...
<a id="pn532-setting_up_tags" aria-hidden="true"></a>
...
<a id="pn532-ndef" aria-hidden="true"></a>

## NDEF

The PN532 supports reading and writing NDEF formatted data into the cards.

<a id="pn532-ndef_reading" aria-hidden="true"></a>
...
<a id="pn532-ndef_writing" aria-hidden="true"></a>
