...
<a id="nextion_binary_sensor" aria-hidden="true"></a>
...
<a id="binary_sensor-nextion-publish_action" aria-hidden="true"></a>
...
<a id="nextion_binary_sensor_lambda_calls" aria-hidden="true"></a>
...
<a id="nextion_binary_sensor_set_state" aria-hidden="true"></a>
...
<a id="nextion_binary_sensor_update" aria-hidden="true"></a>

- `update()`  : Poll from the Nextion

<a id="nextion_binary_sensor_settings" aria-hidden="true"></a>
...
<a id="nextion_binary_sensor_how_things_update" aria-hidden="true"></a>
...
<a id="nextion_custom_binary_sensor_protocol" aria-hidden="true"></a>
