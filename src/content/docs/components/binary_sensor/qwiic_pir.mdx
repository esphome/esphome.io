...
<Img src="qwiic_pir.jpg" alt="Image" caption="SparkFun Qwiic PIR sensor. (Credit: [Sparkfun](https://www.sparkfun.com/products/17374), image cropped and compressed)" class="align-center" width="30.0%" />
...
<a id="debounce-modes" aria-hidden="true"></a>
