...
<a id="rdm6300-component" aria-hidden="true"></a>
...
<Img src="rdm6300-full.jpg" alt="Image" class="align-center" width="60.0%" />
...
<a id="rdm6300-on_tag" aria-hidden="true"></a>
...
<a id="rdm6300-tag" aria-hidden="true"></a>
...
<a id="rdm6300-setting_up_tags" aria-hidden="true"></a>
...
<Img src="rdm6300-ui.png" alt="Image" class="align-center" width="80.0%" />

## See Also

- [pn532/](/pn532/)
- [binary_sensor](/components/binary_sensor/)
- <ApiRef text="rdm6300/rdm6300.h" path="rdm6300/rdm6300.h" />
