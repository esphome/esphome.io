...
<Img src="sun_gtil2_controller_board.png" alt="Image" caption="Pinout of the inverter's controller board" class="align-center" width="50.0%" />

<Img src="sun_gtil2_display_board.png" alt="Image" caption="Pinout of the inverter's display board" class="align-center" width="50.0%" />

<Img src="sun_gtil2_schematic.png" alt="Image" caption="Simplified connection diagram" class="align-center" width="75.0%" />
