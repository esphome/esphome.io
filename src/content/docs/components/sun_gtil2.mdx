...
<Image src={sunGtil2ControllerBoardImg} layout="constrained" alt="" />

<Image src={sunGtil2DisplayBoardImg} layout="constrained" alt="" />

<Image src={sunGtil2SchematicImg} layout="constrained" alt="" />
