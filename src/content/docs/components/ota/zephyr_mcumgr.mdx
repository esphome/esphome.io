...
> `nrf54lm20a`, and `efr32mg24` — not just the legacy `platform: nrf52` component named in this
> page's title. See the [Zephyr platform's variant table](/components/zephyr/#variants).
