...
<Image src="/images/seeed_mr60bha2.jpg" width={300} height={300} layout="constrained" alt="" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Seeed Mr60Bha2](/seeed_mr60bha2/) component if you need multiple components.
