...
<a id="config-water-heater" aria-hidden="true"></a>
...
<a id="water-heater-control_action" aria-hidden="true"></a>
...
<a id="water-heater-modes" aria-hidden="true"></a>
...
<a id="water-heater-lambda_calls" aria-hidden="true"></a>
