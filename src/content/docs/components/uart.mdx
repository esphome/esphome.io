...
<a id="uart-hardware_uarts" aria-hidden="true"></a>
...
<a id="uart-write_action" aria-hidden="true"></a>
...
<a id="uart-debugging" aria-hidden="true"></a>
...
<a id="uart-runtime_change" aria-hidden="true"></a>
