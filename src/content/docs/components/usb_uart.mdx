...
| ---------- | ------ | ------ | ------------------------------------------------------- |
| FT23XX     | 0x0403 | 0x6010 | FTDI USB to serial adapter (FT232R/FT2232H/FT4232H/FT232H/FT230X) |
...
The `ft23xx` type supports FTDI USB UART chips. The chip variant is auto-detected from the USB device descriptor (`bcdDevice`), covering AM, BM, FT2232C, FT232R, FT2232H, FT4232H, FT232H and FT230X. The default PID (`0x6010`) matches the FT2232H; set `pid: 0` to match any FTDI device.
