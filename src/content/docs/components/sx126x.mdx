...
<a id="sx126x" aria-hidden="true"></a>
...
<Img src="sx126x-full.png" alt="Image" class="align-center" width="50.0%" />
...
> after calling `configure`. See <ApiRef text="sx126x/sx126x.h" path="sx126x/sx126x.h" />.
...
- [index/](/)
- <ApiRef text="sx126x/sx126x.h" path="sx126x/sx126x.h" />
