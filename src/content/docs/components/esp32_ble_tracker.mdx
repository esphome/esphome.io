...
- **max_connections** (*Optional*, int): **DEPRECATED** - This option has been moved to the [Esp32 Ble](/esp32_ble/) component.
...
- [Ble Rssi](/sensor/ble_rssi/)
- [B Parasite](/sensor/b_parasite/)
- [Xiaomi Ble](/sensor/xiaomi_ble/)
- [Xiaomi Miscale](/sensor/xiaomi_miscale/)
- [Inkbird Ibsth1 Mini](/sensor/inkbird_ibsth1_mini/)
- [Mopeka Pro Check](/sensor/mopeka_pro_check/)
