...
<a id="config-esp32_ble_tracker" aria-hidden="true"></a>
...
- **max_connections** (*Optional*, int): **DEPRECATED** - This option has been moved to the [esp32_ble/](/esp32_ble/) component.
...
<a id="esp32_ble_tracker-on_ble_advertise" aria-hidden="true"></a>
...
<a id="esp32_ble_tracker-on_ble_manufacturer_data_advertise" aria-hidden="true"></a>
...
<a id="esp32_ble_tracker-on_ble_service_data_advertise" aria-hidden="true"></a>
