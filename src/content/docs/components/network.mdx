...
- **enable_ipv4** (*Optional*, boolean): Enables IPv4 support. Defaults to `true`. Setting this to `false` is rejected if another component or the microcontroller platform requires IPv4.
