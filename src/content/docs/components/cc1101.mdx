...
This [action](/automations/actions#all-actions) sets the operating frequency at runtime.

#### Configuration variables

- **value** (**Required**, frequency, [templatable](/automations/templates)): The frequency value. Range: `300MHz` to `928MHz`.

### `cc1101.set_output_power` Action

This [action](/automations/actions#all-actions) sets the transmission power at runtime.

#### Configuration variables

- **value** (**Required**, float, [templatable](/automations/templates)): The power value in dBm. Range: `-30` to `11`.

### `cc1101.set_modulation_type` Action

This [action](/automations/actions#all-actions) sets the modulation format at runtime.

#### Configuration variables

- **value** (**Required**, enum, [templatable](/automations/templates)): The modulation type. Options: `ASK/OOK`, `2-FSK`, `4-FSK`, `GFSK`, `MSK`.

### `cc1101.set_symbol_rate` Action

This [action](/automations/actions#all-actions) sets the symbol rate at runtime.

#### Configuration variables

- **value** (**Required**, float, [templatable](/automations/templates)): The symbol rate in Baud. Range: `600` to `500000`.

### `cc1101.set_rx_attenuation` Action

This [action](/automations/actions#all-actions) sets the internal RX attenuation at runtime.

#### Configuration variables

- **value** (**Required**, enum, [templatable](/automations/templates)): The RX attenuation. Options: `0dB`, `6dB`, `12dB`, `18dB`.

### `cc1101.set_dc_blocking_filter` Action

This [action](/automations/actions#all-actions) enables or disables the digital DC blocking filter at runtime.

#### Configuration variables

- **value** (**Required**, boolean, [templatable](/automations/templates)): Whether to enable the DC blocking filter.
...
- **value** (**Required**, boolean, [templatable](/automations/templates)): Whether to enable Manchester encoding.

### `cc1101.set_filter_bandwidth` Action

This [action](/automations/actions#all-actions) sets the receive filter bandwidth at runtime.

#### Configuration variables

- **value** (**Required**, frequency, [templatable](/automations/templates)): The filter bandwidth. Range: `58kHz` to `812kHz`.

### `cc1101.set_fsk_deviation` Action

This [action](/automations/actions#all-actions) sets the frequency deviation for FSK/GFSK modulation at runtime.

#### Configuration variables

- **value** (**Required**, frequency, [templatable](/automations/templates)): The FSK deviation. Range: `1.5kHz` to `381kHz`.

### `cc1101.set_msk_deviation` Action

This [action](/automations/actions#all-actions) sets the deviation index for MSK modulation at runtime.

#### Configuration variables

- **value** (**Required**, int, [templatable](/automations/templates)): The MSK deviation index. Range: `1` to `8`.

### `cc1101.set_channel` Action

This [action](/automations/actions#all-actions) sets the channel number at runtime.

#### Configuration variables

- **value** (**Required**, int, [templatable](/automations/templates)): The channel number.

### `cc1101.set_channel_spacing` Action

This [action](/automations/actions#all-actions) sets the spacing between channels at runtime.

#### Configuration variables

- **value** (**Required**, frequency, [templatable](/automations/templates)): The channel spacing. Range: `25kHz` to `405kHz`.

### `cc1101.set_if_frequency` Action

This [action](/automations/actions#all-actions) sets the intermediate frequency at runtime.

#### Configuration variables

- **value** (**Required**, frequency, [templatable](/automations/templates)): The IF frequency. Range: `25kHz` to `788kHz`.
