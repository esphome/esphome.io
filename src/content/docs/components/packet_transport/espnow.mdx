...
> **NOTE:** The `provider` field in the sensor definition is the device name (in the YAML) of the provider esphome device.
> This name is sent in the packet_transport data.
