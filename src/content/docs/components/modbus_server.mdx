...
>
> - If the read half fails — for example because it targets an unmapped or write-only register — the client receives an
>   exception response even though the write has already taken effect.
