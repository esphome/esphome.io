...
<a id="display-fonts" aria-hidden="true"></a>
...
<Img src="fontmetrics.png" alt="Image" caption="The fontmetric values provided by ESPHome." class="align-center" width="60.0%" />
