...
File and animation images can use [automatic image encoding](/components/image/file/#automatic-image-encoding)
to select RGB565 or RGB888 storage for their target at build time. Runtime image platforms require an explicit type.
