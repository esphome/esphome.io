...
on displays. Animations support all options of the [`file` platform](/components/image#the-file-platform) and add
...
The `animation` platform supports all options of the [`file` platform](/components/image#the-file-platform), such as
