...
>
> This component implements the same protocol as the [HCPBridge](https://github.com/hkiam/HCPBridge) and is based off of [14yannick's ESPHome port](https://github.com/14yannick/esphome-hcpbridge)
> project.
