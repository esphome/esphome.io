...
- **authorizer** (**Required**, [ID](/guides/configuration-types#id)): A [binary sensor](/binary_sensor/) to authorize with.
...
- **status_indicator** (*Optional*, [ID](/guides/configuration-types#id)): An [output](/output/) to display feedback to the user.
...
<a id="improv-automations" aria-hidden="true"></a>
...
<a id="improv-on_start" aria-hidden="true"></a>
...
<a id="improv-on_provisioned" aria-hidden="true"></a>
...
<a id="improv-on_provisioning" aria-hidden="true"></a>
...
<a id="improv-on_stop" aria-hidden="true"></a>
...
<a id="improv-on_state" aria-hidden="true"></a>
