...
- **authorizer** (**Required**, [ID](/guides/configuration-types#id)): A [binary sensor](/components/binary_sensor/index/) to authorize with.
...
- **status_indicator** (*Optional*, [ID](/guides/configuration-types#id)): An [output](/components/output/index/) to display feedback to the user.
...
- [Improv Serial](/components/improv_serial/)
