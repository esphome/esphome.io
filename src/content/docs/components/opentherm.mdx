...
<Img src="opentherm-shield.png" alt="Image" caption="DIYLESS Master OpenTherm Shield." class="align-center" width="50.0%" />
...
<a id="on-the-fly-message-editing" aria-hidden="true"></a>
...
<a id="thermostat-pid-basic" aria-hidden="true"></a>
