...
- **response_size** (*Optional*, int): Number of bytes of the response. The default is derived from `register_count`. Only override it for non-standard response lengths.
