...
- **channel** (*Optional*, int): The Wi-Fi channel that the esp-now communication will use to send/receive data packets.
  Cannot be set when the [wifi/](/wifi/) is used, as it will use the same channel as the wifi network.
...
<a id="espnow-on_receive" aria-hidden="true"></a>
...
<a id="espnow-on_unknown_peer" aria-hidden="true"></a>
...
<a id="espnow-on_broadcast" aria-hidden="true"></a>
...
<a id="espnow-send-action" aria-hidden="true"></a>
...
<a id="espnow-broadcast-action" aria-hidden="true"></a>
...
<a id="espnow-peer_add-action" aria-hidden="true"></a>
...
<a id="espnow-peer_delete-action" aria-hidden="true"></a>
...
<a id="espnow-set_channel-action" aria-hidden="true"></a>
...
<a id="espnow-peers" aria-hidden="true"></a>
