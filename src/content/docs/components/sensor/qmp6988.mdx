...
<Img src="qmp6988_env3.png" alt="Image" caption="QMP6988 Temperature and Pressure Sensor." class="align-center" width="40.0%" />
...
<a id="qmp6988-oversampling" aria-hidden="true"></a>
...
- <ApiRef text="qmp6988/qmp6988.h" path="qmp6988/qmp6988.h" />
