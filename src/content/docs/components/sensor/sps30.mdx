...
<Img src="sensirion-pm.png" alt="Image" class="align-center" width="50.0%" />
...
<Img src="sps30-wiring.png" alt="Image" class="align-center" width="50.0%" />
...
<a id="sps30-start_fan_autoclean_action" aria-hidden="true"></a>
