...
<Img src="bmp581.jpg" alt="Image" caption="BMP581 Temperature and Pressure Sensor. (Credit: [SparkFun](https://www.sparkfun.com/products/20170), image cropped and compressed)" class="align-center" width="50.0%" />
...
<a id="bmp581-oversampling" aria-hidden="true"></a>
...
<a id="bmp581-iir" aria-hidden="true"></a>
