...
<Img src="bmi160-full.jpg" alt="Image" caption="BMI160 Accelerometer/Gyroscope Sensor." class="align-center" width="50.0%" />

<Img src="bmi160-ui.png" alt="Image" class="align-center" width="80.0%" />
...
- <ApiRef text="bmi160/bmi160.h" path="bmi160/bmi160.h" />
