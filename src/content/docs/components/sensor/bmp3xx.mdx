...
<Img src="bmp388.jpg" alt="Image" caption="BMP388/BMP390 Temperature and Pressure Sensor." class="align-center" width="50.0%" />
...
<a id="bmp3xx-oversampling" aria-hidden="true"></a>
