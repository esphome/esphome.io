...
<Img src="daly_bms_example.png" alt="Image" class="align-center" width="100.0%" />
...
<Img src="daly_bms_pinout.png" alt="Image" caption="Uart Pinout." class="align-center" width="100.0%" />
