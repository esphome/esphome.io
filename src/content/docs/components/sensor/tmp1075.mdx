...
<Img src="tmp1075.jpg" alt="Image" caption="TMP1075 Temperature Sensor. (Credit: [Texas Instruments](https://www.ti.com/content/dam/ticom/images/products/ic/sensing-products/chips/tmp1075-technical-chip-shot.png), image cropped and compressed)" class="align-center" width="30.0%" />
...
<a id="tmp1075_i2c_addresses" aria-hidden="true"></a>
