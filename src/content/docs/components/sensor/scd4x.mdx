...
<Img src="scd4x.jpg" alt="Image" class="align-center" width="80.0%" />
...
<a id="perform_forced_calibration_action" aria-hidden="true"></a>
...
<a id="factory_reset_action" aria-hidden="true"></a>
