...
other sensors like the [HLW8012](/components/hlw8012/), [HLW8032](/components/hlw8032/), [CSE7766](/components/cse7766/), [ATM90E32](/components/atm90e32/), etc and integrate
it over time.
...
Some sensors such as the [HLW8012](/components/hlw8012/) expose their power sensor with a unit of measurement of
...
For a more-generic version of this component which does not reset every midnight, see [Integration](/components/integration/), which can provide device-lifetime values instead of daily values with the following example settings:
...
- [Hlw8012](/components/hlw8012/)
- [Cse7766](/components/cse7766/)
...
- [Power Meter](/cookbook/power_meter/)
