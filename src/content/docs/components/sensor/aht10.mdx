...
The DHT20 ([datasheet](https://cdn.sparkfun.com/assets/8/a/1/5/0/DHT20.pdf)) sensor has the packaging of the [Dht](/components/dht/) series, but has the AHT20 inside and is speaking [I²C](/components/i2c) as well.

<Image src={aht10FullImg} layout="constrained" alt="" />
