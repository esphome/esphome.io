...
The DHT20 ([datasheet](https://cdn.sparkfun.com/assets/8/a/1/5/0/DHT20.pdf)) sensor has the packaging of the [dht/](/dht/) series, but has the AHT20 inside and is speaking [I²C](/components/i2c) as well.

&lt;Img src="aht10-full.jpg" alt="Image" caption="AHT10 Temperature & Humidity Sensor." class="align-center" width="50.0%" /&gt;
