...
- **adc_voltage_offset** (_Optional_, float): The voltage offset of the ADC sensor used for calibration. Defaults to `0`.
- **adc_voltage_multiplier** (_Optional_, float): The voltage multiplier of the ADC sensor used for calibration. Defaults to `1.0`.
