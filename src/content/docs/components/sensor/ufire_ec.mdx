...
<Img src="ufire_ec.png" alt="Image" class="align-center" width="100.0%" />
...
<a id="sensor-ufire_ec-calibrate_probe_action" aria-hidden="true"></a>
...
<a id="sensor-ufire_ec-reset_action" aria-hidden="true"></a>
