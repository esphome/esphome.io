...
- **energy_native_size** (*Optional*, bool): Use native size for energy counting instead of extended size. Defaults to false, so it can grow larger. Set this to true if you experience unexepected jumps of about 3MWh.
