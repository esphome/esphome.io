...
<Image src="/images/kamstrup_kmp.jpg" width={300} height={257} layout="constrained" alt="" />
...
<Image src={kamstrupKmpSchImg} layout="constrained" alt="" />
...
<Image src={kamstrupKmpHolderImg} layout="constrained" alt="" />
