...
import sen6xWebImg from './images/sen6x-web.png';
...
<Image src={sen6xWebImg} width={491} height={267} layout="constrained" alt="Table showing which sensor signals (PM, RH/T, VOC, NOx, CO2, HCHO) are supported by each SEN6x variant" />
...
<Image src={jst6pinImg} layout="constrained" alt="JST GHR-06V-S 6-pin connector with 1.25mm pitch" />
