...
<Image src="/images/ld2450.png" width={292} height={103} layout="constrained" alt="" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Ld2450](/components/ld2450/) component.
...
- **ld2450_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [Ld2450](/components/ld2450/) component.
...
> [!NOTE]
> By default, each of the [Binary Sensor](/components/binary_sensor/index/) components above includes the
...
> [!NOTE]
> By default, each of the [Sensor](/components/sensor/index/) components above includes the following
...
The `ld2450` switch allows you to control your [Ld2450](/components/ld2450/) `Bluetooth` and `Multi/Single Target Tracking`.
...
- **ld2450_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [Ld2450](/components/ld2450/) component if you are
...
The `ld2450` button allows you to perform `restart` and `factory reset` actions on your [Ld2450](/components/ld2450/).
...
The `ld2450` text sensor allows you to get information about your [Ld2450](/components/ld2450/).
...
The `ld2450` select allows you to control `baud rate` and `zone type` of your [Ld2450](/components/ld2450/).
...
Here is the complete example configuration for [Ld2450](/components/ld2450/).
