...
<a id="ld2450-component" aria-hidden="true"></a>
...
<a id="ld2450-mobile-apps" aria-hidden="true"></a>
...
<Img src="ld2450.png" alt="Image" caption="HLK-LD2450 radar module" class="align-center" width="50.0%" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [ld2450/](/ld2450/) component.
...
<a id="ld2450-binary-sensors" aria-hidden="true"></a>
...
- **ld2450_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [ld2450/](/ld2450/) component.
...
<a id="ld2450-sensors" aria-hidden="true"></a>
...
<a id="ld2450-switch" aria-hidden="true"></a>

## Switch

The `ld2450` switch allows you to control your [ld2450/](/ld2450/) `Bluetooth` and `Multi/Single Target Tracking`.
...
<a id="ld2450-engineering-mode" aria-hidden="true"></a>

### Configuration variables

- **ld2450_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [ld2450/](/ld2450/) component if you are
...
<a id="ld2450-number" aria-hidden="true"></a>
...
The `ld2450` button allows you to perform `restart` and `factory reset` actions on your [ld2450/](/ld2450/).
...
The `ld2450` text sensor allows you to get information about your [ld2450/](/ld2450/).
...
The `ld2450` select allows you to control `baud rate` and `zone type` of your [ld2450/](/ld2450/).
...
<a id="ld2450-light-function" aria-hidden="true"></a>
...
Here is the complete example configuration for [ld2450/](/ld2450/).
...
- <ApiRef text="ld2450/ld2450.h" path="ld2450/ld2450.h" />
