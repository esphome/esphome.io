...
<Img src="ufire_ise.png" alt="Image" class="align-center" width="100.0%" />
...
<a id="sensor-ufire_ise-calibrate_probe_high_action" aria-hidden="true"></a>
...
<a id="sensor-ufire_ise-calibrate_probe_low_action" aria-hidden="true"></a>
...
<a id="sensor-ufire_ise-reset_action" aria-hidden="true"></a>
