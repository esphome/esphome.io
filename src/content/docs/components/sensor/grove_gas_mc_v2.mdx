...
<Img src="grove-gas-mc-v2.png" alt="Image" caption="Grove Multichannel Gas Sensor V2" class="align-center" width="50.0%" />
...
<a id="grove-gas-mc-v2-preheating" aria-hidden="true"></a>
