  ...
  on_boot:
    ...
    then:
      - lambda: |-
          ...
          static std::optional<esphome::modbus_controller::ModbusCommandItem> set_addr_cmd;
          set_addr_cmd.emplace(esphome::modbus_controller::ModbusCommandItem::create_write_single_command(
