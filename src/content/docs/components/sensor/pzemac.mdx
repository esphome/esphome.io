...
<Image src={pzemAcImg} layout="constrained" alt="" />

> [!CAUTION]
> This page refers to version V3 of the PZEM004T.
> For using the older V1 variant of this sensor please see [pzem004t](/components/pzem004t/).
...
- [Pzem004T](/components/pzem004t/)
- [Pzemdc](/components/pzemdc/)
