...
&lt;Img src="zgm053-full.jpg" alt="Image" caption="ZyAura ZGm053U CO2 & Temperature Monitor." class="align-center" width="80.0%" /&gt;

<Img src="zgm053-connection.jpg" alt="Image" caption="ZyAura ZGm053U connection diagram (1 - empty, 2 - clock, 3 - data, 4 - GND). In some other models the clock and data pins are swapped." class="align-center" width="80.0%" />
