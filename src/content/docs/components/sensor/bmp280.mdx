...
<Img src="bmp280-full.jpg" alt="Image" caption="BMP280 Temperature and Pressure Sensor." class="align-center" width="50.0%" />
...
<Img src="bmp280-full.jpg" alt="Image" caption="Pins on the BMP280. Only VCC, GND, SCL, and SDA need to be connected." class="align-center" width="60.0%" />

<a id="bmp280-oversampling" aria-hidden="true"></a>
...
- [bme680/](/bme680/)
- [bmp085/](/bmp085/)
- <ApiRef text="bmp280/bmp280.h" path="bmp280/bmp280.h" />
