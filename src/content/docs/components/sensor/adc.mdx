...
<Img src="adc-ui.png" alt="Image" class="align-center" width="80.0%" />
...
<a id="adc-esp32_attenuation" aria-hidden="true"></a>
...
<a id="adc-esp32_pins" aria-hidden="true"></a>
...
<a id="adc-raw" aria-hidden="true"></a>
...
<a id="adc-vcc" aria-hidden="true"></a>
