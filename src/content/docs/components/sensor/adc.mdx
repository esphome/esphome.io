...
- **attenuation** (*Optional*): On ESP32, or on the `zephyr` platform with an `esp32`/`esp32h2`/`esp32c6`
...
Pin availability on the `zephyr` platform's `esp32`/`esp32h2`/`esp32c6` variants matches ADC1 in
