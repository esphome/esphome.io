...
<a id="apds9960-component" aria-hidden="true"></a>
...
<Img src="apds9960-full.jpg" alt="Image" caption="Image by [SparkFun](https://www.sparkfun.com)." class="align-center" width="80.0%" />
...
The `apds9960` sensor allows you to use your [apds9960/](/apds9960/) to perform different
measurements.
...
The `apds9960` binary sensor allows you to use your [apds9960/](/apds9960/) to perform different
measurements.
...
- <ApiRef text="apds9960/apds9960.h" path="apds9960/apds9960.h" />
