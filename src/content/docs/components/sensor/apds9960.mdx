...
<Image src={apds9960FullImg} layout="constrained" alt="" />
...
The `apds9960` sensor allows you to use your [Apds9960](/components/apds9960/) to perform different
measurements.
...
The `apds9960` binary sensor allows you to use your [Apds9960](/components/apds9960/) to perform different
measurements.
