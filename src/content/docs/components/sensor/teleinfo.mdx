...
<Image src={teleinfoFullImg} layout="constrained" alt="" />
...
<Image src={teleinfoStandardImg} layout="constrained" alt="" />

..

<Image src={teleinfoHistoricalImg} layout="constrained" alt="" />
