...
<Img src="teleinfo-full.jpg" alt="Image" caption="Linky electrical counter" class="align-center" width="50.0%" />
...
<Img src="teleinfo-standard.jpg" alt="Image" caption="Linky electrical counter configured in standard mode." class="align-center" width="50.0%" />

..

<Img src="teleinfo-historical.jpg" alt="Image" caption="Linky electrical counter configured in historical mode." class="align-center" width="50.0%" />
