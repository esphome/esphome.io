...
<Img src="inkbird_isbth1_mini-full.jpg" alt="Image" caption="Inkbird IBS-TH1 Mini Temperature and Humidity Sensor over BLE." class="align-center" width="80.0%" />

<Img src="inkbird_isbth1_mini-ui.png" alt="Image" class="align-center" width="80.0%" />
