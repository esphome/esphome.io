...
| -------------------- | ------------------------------------------------------------------------------------------------------------------ |
| Voltage              | <input type="text" id="sensor-voltage-new" style="width: 100px; max-width: 75vw;" readonly="readonly" /> V |
| Power                | <input type="text" id="sensor-power-new" style="width: 100px; max-width: 75vw;" readonly="readonly" /> W   |
| Current | <input type="text" id="sensor-current-new" style="width: 100px; max-width: 75vw;" readonly="readonly" /> A |

{/* TODO: Inline script - convert to Astro component or client-side JS
...
- <ApiRef text="hlw8012/hlw8012.h" path="hlw8012/hlw8012.h" />
