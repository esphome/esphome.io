...
This component can be considered a more-generic version of the [Total Daily Energy](/components/total_daily_energy/).
...
- [Total Daily Energy](/components/total_daily_energy/)
