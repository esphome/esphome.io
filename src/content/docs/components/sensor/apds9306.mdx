...
<Image src="/images/apds9306.png" width={241} height={240} layout="constrained" alt="" />
...
The `apds9306` sensor allows you to use your [Apds9306](/components/apds9306/) to perform ambient light measurements.
