...
<a id="apds9306-component" aria-hidden="true"></a>
...
<Img src="apds9306.png" alt="Image" caption="Image by Broadcom" class="align-center" width="80.0%" />
...
The `apds9306` sensor allows you to use your [apds9306/](/apds9306/) to perform ambient light measurements.
...
- <ApiRef text="apds9306/apds9306.h" path="apds9306/apds9306.h" />
