...
<Img src="ultrasonic-full.jpg" alt="Image" caption="HC-SR04 Ultrasonic Distance Sensor." class="align-center" width="50.0%" />

<Img src="ultrasonic-ui.png" alt="Image" class="align-center" width="80.0%" />
