...
<a id="msa3xx-component" aria-hidden="true"></a>
...
<Img src="msa311-full.jpg" alt="Image" caption="Module breakout board with MSA311 sensor." class="align-center" width="80.0%" />

<Img src="msa3xx-ui.png" alt="Image" caption="Example of MSA3xx sensor representation in ESPHome dashboard." class="align-center" width="50.0%" />
