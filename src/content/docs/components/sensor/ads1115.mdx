...
<a id="ads1115-component" aria-hidden="true"></a>
...
<Img src="ads1115-full.jpg" alt="Image" caption="ADS1115 16-Bit ADC." class="align-center" width="50.0%" />
...
- **continuous_mode** (*Optional*, boolean): Set if the ADS1115 should continuously measure voltages or
  only measure them when an update is called. Please enable this for the [ct_clamp/](/ct_clamp/) component.
  Defaults to `off`.
...
<a id="ads1115_i2c_addresses" aria-hidden="true"></a>
...
<a id="ads1115-sensor" aria-hidden="true"></a>
...
<Img src="ads1115-ui.png" alt="Image" class="align-center" width="80.0%" />
...
- [adc/](/adc/)
- [max6675/](/max6675/)
- <ApiRef text="ads1115/ads1115.h" path="ads1115/ads1115.h" />
