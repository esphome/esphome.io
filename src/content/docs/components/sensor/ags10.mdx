...
<Img src="ags10.jpg" alt="Image" caption="AGS10 VOC Sensor" class="align-center" width="30.0%" />
...
<a id="sensor-ags10setzeropointaction" aria-hidden="true"></a>
...
<a id="sensor-ags10newi2caddressaction" aria-hidden="true"></a>
