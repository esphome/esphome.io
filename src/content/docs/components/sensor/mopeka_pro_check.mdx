...
Energy devices using a BLE tracker (for example the [ESP32 BLE Tracker](/components/esp32_ble_tracker/)). This component
...
ESPHome can identify it. First, create a simple configuration with a BLE tracker (such as `esp32_ble_tracker`)
