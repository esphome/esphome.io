...
<Image src="/images/ld2410.jpg" width={225} height={225} layout="constrained" alt="" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Ld2410](/components/ld2410/) component if you need multiple
  components.
...
- **ld2410_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [Ld2410](/components/ld2410/) component if you are
...
The `ld2410` number allows you to control the configuration of your [Ld2410](/components/ld2410/).
...
- **id** (**Required**, [ID](/guides/configuration-types#id)): The ID of the [Ld2410](/components/ld2410/) component to set.
