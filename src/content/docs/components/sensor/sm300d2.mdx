...
<Img src="sm300d2-full.jpg" alt="Image" caption="SM300D2 7-in-1 Air Quality Sensor." class="align-center" width="50.0%" />

<Img src="sm300d2-ui.png" alt="Image" class="align-center" width="50.0%" />
...
<Img src="sm300d2-pins.jpg" alt="Image" caption="Pins on the SM300D2. UART RX is not in use." class="align-center" width="80.0%" />

<a id="pins-note" aria-hidden="true"></a>
...
- <ApiRef text="sm300d2/sm300d2.h" path="sm300d2/sm300d2.h" />
