...
<Img src="tmp117.jpg" alt="Image" caption="TMP117 Temperature Sensor. (Credit: [Sparkfun](https://www.sparkfun.com/products/15805), image cropped and compressed)" class="align-center" width="30.0%" />
...
<a id="tmp117_i2c_addresses" aria-hidden="true"></a>
