...
<Img src="pmwcs3.jpg" alt="Image" caption="PMWCS3 Capacitive Soil Moisture and Temperature Sensor." class="align-center" width="80.0%" />
...
<a id="sensor-pmwcs3aircalibrationaction" aria-hidden="true"></a>
...
<a id="sensor-pmwcs3watercalibrationaction" aria-hidden="true"></a>
...
<a id="sensor-pmwcs3newi2caddressaction" aria-hidden="true"></a>
