...
<Img src="ina3221-full.jpg" alt="Image" caption="INA3221 3-Channel DC Current Sensor" class="align-center" width="50.0%" />

<Img src="ina3221-ui.png" alt="Image" class="align-center" width="80.0%" />
...
<Img src="ina3221-pins.jpg" alt="Image" caption="Pins on the INA3221. For communication only VS, GND, SCL and SDA need to be connected. Note that all 3 channels share the same GND reference." class="align-center" width="60.0%" />

## See Also

- [Sensor Filters](/components/sensor#sensor-filters)
- [ina219/](/ina219/)
- <ApiRef text="ina3221/ina3221.h" path="ina3221/ina3221.h" />
