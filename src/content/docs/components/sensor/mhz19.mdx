...
<Img src="mhz19-full.jpg" alt="Image" caption="MH-Z19 CO_2 and Temperature Sensor." class="align-center" width="50.0%" />
...
<Img src="mhz19-pins.jpg" alt="Image" caption="Pins on the MH-Z19. Only the ones marked with a red circle need to be connected." class="align-center" width="80.0%" />

<a id="mhz19-calibrate_zero_action" aria-hidden="true"></a>
...
<a id="mhz19-abc_enable_action" aria-hidden="true"></a>
...
<a id="mhz19-abc_disable_action" aria-hidden="true"></a>
...
<a id="mhz19-detection_range_set_action" aria-hidden="true"></a>
