...
<a id="ld2420-component" aria-hidden="true"></a>
...
<Img src="ld2420.jpg" alt="Image" caption="HLK-LD2420 Low power motion and presence sensor." class="align-center" width="50.0%" />
...
<a id="ld2420-default_values_for_gate_threshold" aria-hidden="true"></a>
...
The `ld2420` sensor allows you to use your [ld2420/](/ld2420/) to approximate the distance
...
The `ld2420` binary sensor allows you to use your [ld2420/](/ld2420/) to sense presence.
...
The `ld2420` text sensor provides version information for the [ld2420/](/ld2420/).
...
- **fw_version** (*Optional*): Allows you to retrieve the [ld2420/](/ld2420/) firmware version. May contain any options from
