...
<Image src="/images/seeed-mr24hpc1.jpg" width={300} height={225} layout="constrained" alt="" />

<Image src={seeedMr24hpc1MmwaveKitImg} layout="constrained" alt="" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Seeed Mr24Hpc1](/seeed_mr24hpc1/) component if you need multiple components.
