...
<Img src="seeed-mr24hpc1.jpg" alt="Image" caption="Seeed Studio 24GHz mmWave Sensor - Human Static Presence Module Lite" class="align-center" width="50.0%" />

<Img src="seeed-mr24hpc1-mmwave-kit.png" alt="Image" caption="Seeed Studio mmWave Human Detection Sensor Kit" class="align-center" width="50.0%" />
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [seeed_mr24hpc1/](/seeed_mr24hpc1/) component if you need multiple components.
...
<a id="seeed_mr24hpc1-spatial_static" aria-hidden="true"></a>

<a id="seeed_mr24hpc1-spatial_mtion" aria-hidden="true"></a>
...
<a id="seeed_mr24hpc1-open_function" aria-hidden="true"></a>

<a id="seeed_mr24hpc1-standard_mode" aria-hidden="true"></a>
...
<a id="seeed_mr24hpc1-custom_mode" aria-hidden="true"></a>
