...
- **startup_delay** (*Optional*, [Time](/guides/configuration-types#time)): Delay all outgoing UART queries by
  ...
  you experience this lockup, a delay of `0s`-`1s` has been observed to fail reliably, while any delay of `1s` or
  more has resolved it in testing; if problems persist, try a longer delay.
