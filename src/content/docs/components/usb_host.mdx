...
- **max_packet_size** (*Optional*, int): Maximum USB packet size in bytes. Defaults to `64` (USB Full Speed). On ESP32-P4 only, this may be set to `512` to enable USB High Speed transfers. This option is not available on other platforms.
