...
title: GPIO Switch
description: >-
  Instructions for setting up GPIO pin switches in ESPHome that control GPIO
  outputs.
seo:
  description: >-
    Instructions for setting up GPIO pin switches in ESPHome that control GPIO
...
- [template](/components/cover/template)
- [garage-door](/cookbook/garage-door)
- ::apiref{text="gpio/switch/gpio_switch.h" path="gpio/switch/gpio_switch.h"}
