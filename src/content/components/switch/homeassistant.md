...
description: >-
  Instructions for setting up Home Assistant Switch with ESPHome that import
  states and allows control via your Home Assistant instance.
seo:
  description: >-
    Instructions for setting up Home Assistant Switch with ESPHome that import
    states and allows control via your Home Assistant instance.
...
- ::apiref{text="homeassistant/switch/homeassistant_switch.h" path="homeassistant/switch/homeassistant_switch.h"}
