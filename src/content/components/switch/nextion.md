...
some more advanced functions (see the full ::apiref{text="nextion/nextion_switch.h" path="nextion/nextion_switch.h"} for more info).
...
- [Link](index/)
- ::apiref{text="nextion/switch/nextion_switch.h" path="nextion/switch/nextion_switch.h"}
