...
description: >-
  Instructions for setting up template switches that can execute arbitrary
  actions when turned on or off.
seo:
  description: >-
    Instructions for setting up template switches that can execute arbitrary
    actions when turned on or off.
...
- ::apiref{text="template/switch/template_switch.h" path="template/switch/template_switch.h"}
