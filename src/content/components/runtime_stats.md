...
description: >-
  Instructions for setting up the runtime statistics component to analyze
  component performance in ESPHome.
seo:
  description: >-
    Instructions for setting up the runtime statistics component to analyze
    component performance in ESPHome.
...
- ::apiref{text="runtime_stats/runtime_stats.h" path="runtime_stats/runtime_stats.h"}
