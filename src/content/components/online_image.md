...
This component has a dependency to [http_request](/components/http_request); the configuration options you set to the `http_request` component will also apply here.
...
- ::apiref{text="online_image/online_image.h" path="online_image/online_image.h"}
