...
some more advanced functions (see the full ::apiref{text="nextion/text_sensor/nextion_textsensor.h" path="nextion/text_sensor/nextion_textsensor.h"} for more info).
...
- [Link](index/)
- ::apiref{text="nextion/text_sensor/nextion_textsensor.h" path="nextion/text_sensor/nextion_textsensor.h"}
