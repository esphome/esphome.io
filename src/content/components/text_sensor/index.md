...
description: >-
  Instructions for setting up text sensors that represent their state as a
  string of text.
seo:
  description: >-
    Instructions for setting up text sensors that represent their state as a
...
Text sensors are a lot like normal [sensors](/components/sensor/index).
...
- ::apiref{text="text_sensor/text_sensor.h" path="text_sensor/text_sensor.h"}
