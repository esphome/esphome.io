...
description: >-
  Instructions for setting up MQTT Subscribe text sensors that show the content
  of a MQTT message as their state.
seo:
  description: >-
    Instructions for setting up MQTT Subscribe text sensors that show the
    content of a MQTT message as their state.
  image: mqtt.png
---
...
- ::apiref{text="mqtt_subscribe/text_sensor/mqtt_subscribe_text_sensor.h" path="mqtt_subscribe/text_sensor/mqtt_subscribe_text_sensor.h"}
