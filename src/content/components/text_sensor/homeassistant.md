...
description: >-
  Instructions for setting up Home Assistant text sensors with ESPHome that
...
- ::apiref{text="homeassistant/text_sensor/homeassistant_text_sensor.h" path="homeassistant/text_sensor/homeassistant_text_sensor.h"}
