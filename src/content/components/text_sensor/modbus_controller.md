...
and requires [modbus_controller](/components/modbus_controller) to be configured.
...
- [modbus_controller](/components/modbus_controller)
- [modbus_controller](/components/sensor/modbus_controller)
- [modbus_controller](/components/binary_sensor/modbus_controller)
- [modbus_controller](/components/output/modbus_controller)
- [modbus_controller](/components/switch/modbus_controller)
- [modbus_controller](/components/number/modbus_controller)
- [modbus_controller](/components/select/modbus_controller)
- [modbus_controller](/components/text_sensor/modbus_controller)
