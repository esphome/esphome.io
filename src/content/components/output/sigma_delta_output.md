...
to output a floating-point value on a binary output. Unlike with [slow_pwm](/components/output/slow_pwm),
...
PWM period of 10 seconds, for reasonably frequent updates, with [slow_pwm](/components/output/slow_pwm)
...
This component can be used as a drop-in replacement for [slow_pwm](/components/output/slow_pwm) by changing the `platform` to
...
> to be off for a while to e.g. cool down, [slow_pwm](/components/output/slow_pwm)
...
- [slow_pwm](/components/output/slow_pwm)
...
- ::apiref{text="sigma_delta_output/sigma_delta_output.h" path="sigma_delta_output/sigma_delta_output.h"}
