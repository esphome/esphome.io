...
> [sigma_delta_output](/components/output/sigma_delta_output) component offers faster updates and
...
- [sigma_delta_output](/components/output/sigma_delta_output)
- [monochromatic](/components/light/monochromatic)
- [speed](/components/fan/speed)
- [power_supply](/components/power_supply)
- ::apiref{text="slow_pwm/slow_pwm_output.h" path="slow_pwm/slow_pwm_output.h"}
