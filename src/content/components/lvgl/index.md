...
title: LVGL Graphics
description: >-
  LVGL - ESPHome Displays showing contents created with Light and Versatile
  Graphics Library
seo:
  description: >-
    LVGL - ESPHome Displays showing contents created with Light and Versatile
...
For interactivity, a [Touchscreen](/components/touchscreen/index) (capacitive highly preferred), a [rotary_encoder](/components/sensor/rotary_encoder) or a custom keypad made up from discrete [Binary Sensors](/components/binary_sensor/index) can be used.
...
- **encoders** (*Optional*, list): A list of rotary encoders interacting with the LVGL widgets on the display.
  ...
  - **enter_button** (**Required**, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `ENTER` key.
  - **sensor** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [rotary_encoder](/components/sensor/rotary_encoder); or a list with buttons for left/right interaction with the widgets:
    - **left_button** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `LEFT` key.
    - **right_button** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `RIGHT` key.
...
- **keypads** (*Optional*, list): A list of keypads interacting with the LVGL widgets on the display.
  - **group** (*Optional*, string): A name for a group of widgets which will interact with the input device. See the [common properties](/components/lvgl/widgets) of the widgets for more information on groups.
  - **up** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `UP` key.
  - **down** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `DOWN` key.
  - **right** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `RIGHT` key.
  - **left** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `LEFT` key.
  - **esc** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `ESC` key.
  - **del** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `DEL` key.
  - **backspace** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `BACKSPACE` key.
  - **enter** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `ENTER` key.
  - **next** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `NEXT` key.
  - **prev** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `PREV` key.
  - **home** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `HOME` key.
  - **end** (*Optional*, [ID](/guides/configuration-types#id)): The ID of a [Binary Sensor](/components/binary_sensor/index), to be used as `END` key.
...
- **update_when_display_idle** (*Optional*, boolean): When using the [epaper_spi](/components/display/epaper_spi)
...
- [rotary_encoder](/components/sensor/rotary_encoder)
