...
title: Rtttl Buzzer
description: >-
  Instructions for setting up a buzzer to play tones and rtttl songs with
  ESPHome.
seo:
  description: >-
    Instructions for setting up a buzzer to play tones and rtttl songs with
...
[ESP8266 Software PWM Output](output/esp8266_pwm) and
[ESP32 LEDC Output](output/ledc) are supported.
...
The tone generator can instead be used with a [Speaker](/components/speaker/index) to output the audio.
...
- ::apiref{text="rtttl/rtttl.h" path="rtttl/rtttl.h"}
