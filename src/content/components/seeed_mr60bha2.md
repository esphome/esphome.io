---
title: >-
  Seeed Studio MR60BHA2 60GHz mmWave Breathing and Heartbeat Detection Sensor
  Kit
description: >-
  Instructions for setting up Seeed Studio MR60BHA2 60GHz mmWave Breathing and
  Heartbeat Detection Sensor Kit.
seo:
  description: >-
    Instructions for setting up Seeed Studio MR60BHA2 60GHz mmWave Breathing and
    Heartbeat Detection Sensor Kit.
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Link](seeed_mr60bha2/) component if you need multiple components.
...
- ::apiref{text="seeed_mr60bha2/seeed_mr60bha2.h" path="seeed_mr60bha2/seeed_mr60bha2.h"}
