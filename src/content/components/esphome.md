...
too many WiFi/MQTT connection attempts, Over-The-Air updates being applied or through the [Link](deep_sleep/).
...
You can do so with the `use_address` option of the [WiFi configuration](wifi).
