...
description: >-
  Instructions for using the ESP32 Hosted update platform to manage co-processor
  firmware updates.
seo:
  description: >-
    Instructions for using the ESP32 Hosted update platform to manage
...
- ::apiref{text="esp32_hosted/update/esp32_hosted_update.h" path="esp32_hosted/update/esp32_hosted_update.h"}
