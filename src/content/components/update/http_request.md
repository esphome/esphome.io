...
description: >-
  Instructions for using ESPHome's http_request update platform to manage
...
- [http_request](/components/http_request)
...
- [http_request](/components/ota/http_request)
- [ota](/components/ota)
- ::apiref{text="update/update_entity.h" path="update/update_entity.h"}
