...
This component allows an ESP32-S3 or ESP32-S2 to host USB-serial peripheral devices. It uses the [usb_host](/components/usb_host)
...
- [usb_host](/components/usb_host)
- ::apiref{text="usb_uart/usb_uart.h" path="usb_uart/usb_uart.h"}
