...
This component allows ESPHome nodes to communicate with Home Assistant over a Thread network. It permits sending sensor state to Home Assistant and receiving [Over-the-Air Updates (OTA)](/components/ota/index). This OpenThread component relies on [OpenThread](https://openthread.io) which is an open-source implementation of Thread.
...
- [openthread_info](/components/text_sensor/openthread_info)
- [network](/components/network)
- ::apiref{text="openthread/openthread.h" path="openthread/openthread.h"}
- <https://openthread.io/>
