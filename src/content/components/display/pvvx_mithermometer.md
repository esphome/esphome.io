...
description: >-
  Instructions for setting up BLE devices with PVVX MiThermometer custom
  firmware as displays.
seo:
  description: >-
    Instructions for setting up BLE devices with PVVX MiThermometer custom
    firmware as displays.
...
- [xiaomi_ble](/components/sensor/xiaomi_ble)
- ::apiref{text="pvvx_mithermometer/display/pvvx_display.h" path="pvvx_mithermometer/display/pvvx_display.h"}
