...
simple display updates. There are too many to cover here; please see the ::apiref{text="nextion/nextion.h" path="nextion/nextion.h"} for more detail.
...
logging or other [automations](/automations/index) will occur. This process uses the same protocol as the
...
With the exception of the [nextion](../binary_sensor/nextion) that has the `page_id`  /`component_id` options configured,
...
- [Link](index/)
- [nextion](../binary_sensor/nextion)
- [nextion](../sensor/nextion)
- [nextion](../switch/nextion)
- [nextion](../text_sensor/nextion)
- [uart](../uart)
- ::apiref{text="nextion/nextion.h" path="nextion/nextion.h"}
