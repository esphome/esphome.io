...
- Character displays like [7-Segment displays](max7219) or
  [LCD displays](lcd_display).

- Serial displays like [Link](nextion/) that have their own processors for graphics rendering.
- Graphical displays with fully addressable pixels, such as
  [SPI interfaced LCDs](mipi_spi),
  [E-Paper](waveshare_epaper),
  [HUB75 LED matrices](hub75),
  and [OLED](ssd1306).
...
- [LVGL](/components/lvgl/index) - Light and Versatile Graphics Library
...
> you can use the [mqtt_subscribe](/components/text_sensor/mqtt_subscribe) (see the example there for more information).
...
- ::apiref{text="display/display_buffer.h" path="display/display_buffer.h"}
- [index](/components/lvgl/index)
- [mipi_spi](/components/display/mipi_spi)
- [mipi_rgb](/components/display/mipi_rgb)
- [mipi_dsi](/components/display/mipi_dsi)
