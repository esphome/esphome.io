...
When using this display with [LVGL](/components/lvgl/index), you must configure the display as follows:
...
- [Link](index/)
- [LVGL Component](/components/lvgl/index)
- ::apiref{text="hub75/hub75_component.h" path="hub75/hub75_component.h"}
