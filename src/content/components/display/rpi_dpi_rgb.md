...
> [!WARNING]
> This component has been made redundant since this class of displays is now supported by the [mipi_rgb](mipi_rgb)
...
- [Link](index/)
- ::apiref{text="rpi_dpi_rgb/rpi_dpi_rgb.h" path="rpi_dpi_rgb/rpi_dpi_rgb.h"}
