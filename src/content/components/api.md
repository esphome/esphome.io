...
description: >-
  Instructions for setting up the native ESPHome API for communication with Home
  Assistant.
seo:
  description: >-
    Instructions for setting up the native ESPHome API for communication with
    Home Assistant.
...
- ::apiref{text="api/api_server.h" path="api/api_server.h"}
