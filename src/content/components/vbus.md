...
description: >-
  Instructions for integrating a solar energy collector controller using VBus
  protocol in ESPHome.
seo:
  description: >-
    Instructions for integrating a solar energy collector controller using VBus
...
> [!WARNING]
> If you are using the [Link](logger/) make sure you are not using the same pins for it or otherwise disable the UART
