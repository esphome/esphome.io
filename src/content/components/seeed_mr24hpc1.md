...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Link](seeed_mr24hpc1/) component if you need multiple components.
...
- ::apiref{text="seeed_mr24hpc1/seeed_mr24hpc1.h" path="seeed_mr24hpc1/seeed_mr24hpc1.h"}
