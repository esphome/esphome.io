...
title: Status LED
description: >-
  Instructions for setting up status LEDs in ESPHome to monitor the status of an
  ESP.
seo:
  description: >-
    Instructions for setting up status LEDs in ESPHome to monitor the status of
    an ESP.
  image: led-on.svg
---
...
- [status_led](/components/light/status_led)
- ::apiref{text="status_led/status_led.h" path="status_led/status_led.h"}
