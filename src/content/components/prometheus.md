...
[Link](web_server/) in order to integrate a [Prometheus](https://prometheus.io/) installation.
...
- ::apiref{text="prometheus/prometheus_handler.h" path="prometheus/prometheus_handler.h"}
