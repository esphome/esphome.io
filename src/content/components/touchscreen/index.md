...
This trigger provides one argument named `touches` of type ::apiref{text="touchscreen::TouchPoints_t" path="touchscreen::TouchPoints_t"} which has a list of
...
- ::apiref{text="touchscreen/touchscreen.h" path="touchscreen/touchscreen.h"}
- ::apiref{text="touchscreen/binary_sensor/touchscreen_binary_sensor.h" path="touchscreen/binary_sensor/touchscreen_binary_sensor.h"}
