...
The `resampler` speaker platform allows you to convert the sample rate of an audio stream and output it to another [speaker component](/components/speaker/index).
...
- **output_speaker** (**Required**, [ID](/guides/configuration-types#id)): The [speaker](/components/speaker/index) to output the resampled audio.
