...
description: >-
  Instructions for setting up a Dallas (Analog Devices) 1-Wire bus via a GPIO
  pin to communicate with 1-wire devices in ESPHome
seo:
  description: >-
    Instructions for setting up a Dallas (Analog Devices) 1-Wire bus via a GPIO
    pin to communicate with 1-wire devices in ESPHome
...
- [Link](index/)
- ::apiref{text="one_wire/one_wire_bus.h" path="one_wire/one_wire_bus.h"}
