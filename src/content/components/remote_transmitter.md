...
description: >-
  Instructions for setting up configurations that send out pre-defined sequences
  of IR or RF signals
seo:
  description: >-
    Instructions for setting up configurations that send out pre-defined
    sequences of IR or RF signals
  image: remote.svg
---
...
- [Link](index/)
- [remote_receiver](/components/remote_receiver)
...
- [rf_bridge](/components/rf_bridge)
...
- ::apiref{text="remote_transmitter/remote_transmitter.h" path="remote_transmitter/remote_transmitter.h"}
