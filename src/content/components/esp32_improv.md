...
The `esp32_improv` component will automatically set up the [BLE Server](esp32_ble).
...
- **authorizer** (**Required**, [ID](/guides/configuration-types#id)): A [binary sensor](binary_sensor/index) to authorize with.
...
- **status_indicator** (*Optional*, [ID](/guides/configuration-types#id)): An [output](output/index) to display feedback to the user.
...
- ::apiref{text="esp32_improv/esp32_improv_component.h" path="esp32_improv/esp32_improv_component.h"}
