...
description: >-
  Instructions for setting up generic output buttons in ESPHome that control an
  output component.
seo:
  description: >-
    Instructions for setting up generic output buttons in ESPHome that control
    an output component.
  image: upload.svg
---
...
- ::apiref{text="output/button/output_button.h" path="output/button/output_button.h"}
