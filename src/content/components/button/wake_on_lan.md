...
description: >-
  Instructions for setting up buttons that can send wakeup packets to computers
  on the network.
seo:
  description: >-
    Instructions for setting up buttons that can send wakeup packets to
...
- [Link](template/)
- ::apiref{text="wake_on_lan/wake_on_lan.h" path="wake_on_lan/wake_on_lan.h"}
