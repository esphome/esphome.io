...
description: >-
  Instructions for setting up buttons that can remotely invalidate all ESPHome
...
- [Link](restart/)
- [Link](safe_mode/)
- [factory_reset](/components/switch/factory_reset)
- [Link](template/)
- ::apiref{text="factory_reset/factory_reset_button.h" path="factory_reset/factory_reset_button.h"}
