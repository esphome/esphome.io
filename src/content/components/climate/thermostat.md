...
physical thermostat. Its operation is similar to the [Bang-Bang](bang_bang) controller; a sensor measures a value
...
When configured for both heating and cooling, it is essentially two [Bang-Bang](bang_bang) controllers in one; it
...
Please see the [Bang-Bang](bang_bang) component's documentation for a detailed comparison of these two components.
