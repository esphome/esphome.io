...
> [!NOTE]
> The [thermostat](thermostat) component behaves more like a common thermostat; it is
...
two key differences between the bang-bang component and the [thermostat](thermostat) component:
...
The [thermostat](thermostat) component differs in that there is hysteresis around *each* set point. For example,
...
is associated with heating while the other with cooling, and this is exactly how the [thermostat](thermostat)
...
In all other situations, the [thermostat](thermostat) component is probably best.

## See Also

- [climate](/components/climate)
- ::apiref{text="bang_bang/bang_bang_climate.h" path="bang_bang/bang_bang_climate.h"}
