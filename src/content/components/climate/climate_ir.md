...
This component requires that you have configured a [remote_transmitter](/components/remote_transmitter).
...
However, when receiver is supported, you can optionally add a [remote_receiver](/components/remote_receiver)
