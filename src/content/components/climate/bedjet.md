...
this component. Please see the [ble_client](/components/ble_client) docs for how to discover the MAC
...
>
> To set up a (dis-)connect switch, see [ble_client](/components/switch/ble_client).
...
- ::apiref{text="bedjet/bedjet.h" path="bedjet/bedjet.h"}
