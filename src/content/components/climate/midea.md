...
- **uart_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID of the [uart](../uart) if you want
  to use multiple UART buses.

- **transmitter_id** (*Optional*, [ID](/guides/configuration-types#id)): Defined and used automatically when using [remote_transmitter](../remote_transmitter) component for IR commands transmit.
...
This action toggle ac screen. Works via UART if supported or [remote_transmitter](../remote_transmitter).
...
This action adjust the louver by one step. [remote_transmitter](../remote_transmitter) required.
...
Below is an example of how to send FollowMe commands with the values of your sensor using the [remote_transmitter](../remote_transmitter)
...
- ::apiref{text="climate/midea_ac.h" path="climate/midea_ac.h"}
