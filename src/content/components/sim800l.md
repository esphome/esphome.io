...
description: >-
  Instructions for setting up the SIM800L GSM module to dial, send and receive
  SMS in ESPHome.
seo:
  description: >-
    Instructions for setting up the SIM800L GSM module to dial, send and receive
...
> [!WARNING]
> If you are using the [Link](logger/) make sure you are not using the same pins for `TX` and `RX` or
...
- ::apiref{text="sim800l/sim800l.h" path="sim800l/sim800l.h"}
