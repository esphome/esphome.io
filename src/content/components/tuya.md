...
- **time_id** (*Optional*, [ID](/guides/configuration-types#id)): Some Tuya devices support obtaining local time from ESPHome.
  Specify the ID of the [Link](time/) which will be used.
...
- [tuya](/components/fan/tuya)
- [tuya](/components/light/tuya)
- [tuya](/components/switch/tuya)
- [tuya](/components/climate/tuya)
- [tuya](/components/binary_sensor/tuya)
- [tuya](/components/sensor/tuya)
- [tuya](/components/text_sensor/tuya)
- [tuya](/components/number/tuya)
- ::apiref{text="tuya/tuya.h" path="tuya/tuya.h"}
