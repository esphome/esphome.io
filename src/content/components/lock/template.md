...
title: Template Lock
description: >-
  Instructions for setting up template locks that can execute arbitrary actions
  when locked, unlocked, or opened
seo:
  description: >-
    Instructions for setting up template locks that can execute arbitrary
    actions when locked, unlocked, or opened
...
- ::apiref{text="template/lock/template_lock.h" path="template/lock/template_lock.h"}
