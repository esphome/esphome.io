...
description: >-
  Instructions for setting up ESP32 bluetooth low energy device trackers using
  ESPHome.
seo:
  description: >-
    Instructions for setting up ESP32 bluetooth low energy device trackers using
...
- **max_connections** (*Optional*, int): **DEPRECATED** - This option has been moved to the [Link](esp32_ble/) component.
...
- [ble_scanner](text_sensor/ble_scanner)
- [ble_rssi](sensor/ble_rssi)
- [b_parasite](sensor/b_parasite)
- [xiaomi_ble](sensor/xiaomi_ble)
- [xiaomi_miscale](sensor/xiaomi_miscale)
- [inkbird_ibsth1_mini](sensor/inkbird_ibsth1_mini)
- [mopeka_pro_check](sensor/mopeka_pro_check)
- [ruuvitag](sensor/ruuvitag)
- [Link](ble_client/)
- [Link](bluetooth_proxy/)
- ::apiref{text="esp32_ble_tracker/esp32_ble_tracker.h" path="esp32_ble_tracker/esp32_ble_tracker.h"}
