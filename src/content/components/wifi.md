...
description: >-
  Instructions for setting up the WiFi configuration for your ESP node in
  ESPHome.
seo:
  description: >-
    Instructions for setting up the WiFi configuration for your ESP node in
...
Some components such as [Link](captive_portal/), [Link](improv_serial/) and
[Link](esp32_improv/) enable the user to send and save Wi-Fi credentials to the device. Beginning in 2022.11.0,
...
- [Link](captive_portal/)
- [wifi_info](text_sensor/wifi_info)
- [wifi_signal](sensor/wifi_signal)
- [Link](network/)
- [ethernet](/components/ethernet)
- [Link](api/)
- ::apiref{text="wifi/wifi_component.h" path="wifi/wifi_component.h"}
