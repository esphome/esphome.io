...
title: UART Event
description: >-
  Instructions for setting up UART event in ESPHome that can be triggered based
  on incoming UART data.
seo:
  description: >-
    Instructions for setting up UART event in ESPHome that can be triggered
    based on incoming UART data.
  image: uart.svg
---
...
- ::apiref{text="uart/event/uart_event.h" path="uart/event/uart_event.h"}
