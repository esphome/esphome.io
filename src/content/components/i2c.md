...
title: I²C Bus
description: >-
  Instructions for setting up the I²C bus to communicate with 2-wire devices in
  ESPHome
seo:
  description: >-
    Instructions for setting up the I²C bus to communicate with 2-wire devices
    in ESPHome
  image: i2c.svg
---
...
- [tca9548a](/components/tca9548a)
- [i2c_device](/components/i2c_device)
- ::apiref{text="i2c/i2c.h" path="i2c/i2c.h"}
