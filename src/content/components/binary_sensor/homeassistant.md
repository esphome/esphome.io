...
description: >-
  Instructions for setting up Home Assistant binary sensors with ESPHome that
  import states from your Home Assistant instance.
seo:
  description: >-
    Instructions for setting up Home Assistant binary sensors with ESPHome that
    import states from your Home Assistant instance.
...
- ::apiref{text="homeassistant/binary_sensor/homeassistant_binary_sensor.h" path="homeassistant/binary_sensor/homeassistant_binary_sensor.h"}
