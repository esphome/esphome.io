...
description: >-
  Instructions for setting up Bluetooth Low Energy iBeacons using the BLE
  feature on ESP32s.
seo:
  description: >-
    Instructions for setting up Bluetooth Low Energy iBeacons using the BLE
...
- [Link](esp32_ble_tracker/)
- [ble_presence](binary_sensor/ble_presence)
- ::apiref{text="esp32_ble_beacon/esp32_ble_beacon.h" path="esp32_ble_beacon/esp32_ble_beacon.h"}
