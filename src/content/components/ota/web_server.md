...
description: >-
  Instructions for setting up Over-The-Air (OTA) updates via the ESPHome web
  interface.
seo:
  description: >-
    Instructions for setting up Over-The-Air (OTA) updates via the ESPHome web
...
> [!NOTE]
> This platform requires the [web_server](/components/web_server) component to be configured in your device.
