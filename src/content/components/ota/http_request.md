...
description: >-
  Instructions for setting up Over-The-Air (OTA) updates for ESPs to download
  firmwares remotely by HTTP.
seo:
  description: >-
    Instructions for setting up Over-The-Air (OTA) updates for ESPs to download
    firmwares remotely by HTTP.
...
To use this platform, the [Link](http_request/) component must be present in your configuration.
...
- ::apiref{text="ota/ota_component.h" path="ota/ota_component.h"}
- [ota](/components/ota)
- [esphome](/components/ota/esphome)
- [safe_mode](/components/safe_mode)
