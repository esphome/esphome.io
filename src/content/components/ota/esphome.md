...
description: >-
  Instructions for setting up ESPHome's Over-The-Air (OTA) platform to allow
  remote updating of devices.
seo:
  description: >-
    Instructions for setting up ESPHome's Over-The-Air (OTA) platform to allow
    remote updating of devices.
...
[safe_mode](/components/safe_mode) for details.
...
- [ota](/components/ota)
- [http_request](/components/ota/http_request)
