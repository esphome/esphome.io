...
seo:
  description: >-
    Instructions for setting up STTS22H temperature sensor from
    STMicroelectronics with ESPHome
  image: stts22h.png
---
...
::img{src="stts22h.png" alt="STTS22H Temperature Sensor" caption="SparkFun STTS22H Temperature Sensor Breakout Boards" class="align-center"}
