...
from a voltage sensor (such as the [ADC Sensor](adc)) into resistance readings
in Ω (ohm).
...
::img{src="resistance-downstream.png" alt="Image" caption="Example voltage divider configuration of type \" width="25.0%" class="align-center"}
...
- ::apiref{text="resistance/resistance_sensor.h" path="resistance/resistance_sensor.h"}
