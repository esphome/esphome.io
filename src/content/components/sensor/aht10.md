...
The DHT20 ([datasheet](https://cdn.sparkfun.com/assets/8/a/1/5/0/DHT20.pdf)) sensor has the packaging of the [Link](dht/) series, but has the AHT20 inside and is speaking [I²C](/components/i2c) as well.
...
- ::apiref{text="aht10/aht10.h" path="aht10/aht10.h"}
