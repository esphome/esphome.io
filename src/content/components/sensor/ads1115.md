...
description: >-
  Instructions for setting up ADS1115/ADS1015 multiplexed analog voltage
  sensors.
seo:
  description: >-
    Instructions for setting up ADS1115/ADS1015 multiplexed analog voltage
...
- **continuous_mode** (*Optional*, boolean): Set if the ADS1115 should continuously measure voltages or
  only measure them when an update is called. Please enable this for the [Link](ct_clamp/) component.
  Defaults to `off`.
