...
The `apds9960` sensor allows you to use your [Link](apds9960/) to perform different
measurements.
...
The `apds9960` binary sensor allows you to use your [Link](apds9960/) to perform different
measurements.
