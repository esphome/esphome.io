...
description: >-
  Instructions for setting up Home Assistant sensors with ESPHome that import
  states from your Home Assistant instance.
seo:
  description: >-
    Instructions for setting up Home Assistant sensors with ESPHome that import
    states from your Home Assistant instance.
...
- ::apiref{text="homeassistant/sensor/homeassistant_sensor.h" path="homeassistant/sensor/homeassistant_sensor.h"}
