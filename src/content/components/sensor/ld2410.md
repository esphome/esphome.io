...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Link](ld2410/) component if you need multiple
  components.
...
- **ld2410_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [Link](ld2410/) component if you are
...
The `ld2410` number allows you to control the configuration of your [Link](ld2410/).
...
- **id** (**Required**, [ID](/guides/configuration-types#id)): The ID of the [Link](ld2410/) component to set.
