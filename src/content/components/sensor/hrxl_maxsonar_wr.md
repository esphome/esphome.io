...
description: >-
  Instructions for setting up MaxBotix HRXL or XL MaxSonar WR ultrasonic
  distance measurement sensors in ESPHome.
seo:
  description: >-
    Instructions for setting up MaxBotix HRXL or XL MaxSonar WR ultrasonic
    distance measurement sensors in ESPHome.
...
- [Link](template/)
- ::apiref{text="hrxl_maxsonar_wr/hrxl_maxsonar_wr.h" path="hrxl_maxsonar_wr/hrxl_maxsonar_wr.h"}
