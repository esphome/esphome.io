...
To maximize the chances of catching advertisements of the sensors, you can set `interval` equal to `window` in [esp32_ble_tracker](/components/esp32_ble_tracker) scan parameter settings:
...
- [pvvx_mithermometer](/components/display/pvvx_mithermometer)
- ::apiref{text="xiaomi_lywsd03mmc/xiaomi_ble.h" path="xiaomi_lywsd03mmc/xiaomi_ble.h"}
- [ethernet](/components/ethernet)
- [bluetooth_proxy](/components/bluetooth_proxy)
