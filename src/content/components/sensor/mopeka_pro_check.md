...
description: >-
  Instructions for setting up Mopeka Pro Check or Lippert Propane Tank
  bluetooth-based sensors in ESPHome.
seo:
  description: >-
    Instructions for setting up Mopeka Pro Check or Lippert Propane Tank
    bluetooth-based sensors in ESPHome.
...
Energy devices using the [esp32_ble_tracker](/components/esp32_ble_tracker). This component
...
>
> See [mopeka_std_check](/components/sensor/mopeka_std_check) for original Mopeka Check sensors support.
...
+ ::apiref{text="mopeka_pro_check/mopeka_pro_check.h" path="mopeka_pro_check/mopeka_pro_check.h"}
