...
description: >-
  Instructions for setting up ThermoPro Bluetooth-based temperature and humidity
  sensors in ESPHome.
seo:
  description: >-
    Instructions for setting up ThermoPro Bluetooth-based temperature and
    humidity sensors in ESPHome.
  image: thermopro_tp357.jpg
---

The `thermopro_ble` sensor platform lets you track the output of ThermoPro Bluetooth
Low Energy devices using the [esp32_ble_tracker](/components/esp32_ble_tracker). This component will track the
...
- ::apiref{text="thermopro_ble/thermopro_ble.h" path="thermopro_ble/thermopro_ble.h"}
