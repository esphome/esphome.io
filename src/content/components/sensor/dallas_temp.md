...
and similar 1-Wire temperature sensors. A [1-Wire bus](/components/one_wire/index) is
...
- **one_wire_id** (*Optional*, [one_wire](/components/one_wire)): The ID of the 1-Wire bus to use.
...
- ::apiref{text="dallas_temp/dallas_temp.h" path="dallas_temp/dallas_temp.h"}
