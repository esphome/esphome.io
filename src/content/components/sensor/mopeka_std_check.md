...
description: >-
  Instructions for setting up Mopeka Standard Check bluetooth-based sensors in
  ESPHome.
seo:
  description: >-
    Instructions for setting up Mopeka Standard Check bluetooth-based sensors in
...
[esp32_ble_tracker](/components/esp32_ble_tracker). This component will track the tank level,
...
> See [mopeka_pro_check](/components/sensor/mopeka_pro_check) for Mopeka Pro Check sensors support.
...
- ::apiref{text="mopeka_std_check/mopeka_std_check.h" path="mopeka_std_check/mopeka_std_check.h"}
