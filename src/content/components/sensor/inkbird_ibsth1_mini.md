...
description: >-
  Instructions for setting up Inkbird IBS-TH1/TH2 Bluetooth-based temperature
  and humidity sensors in ESPHome.
seo:
  description: >-
    Instructions for setting up Inkbird IBS-TH1/TH2 Bluetooth-based temperature
    and humidity sensors in ESPHome.
...
- ::apiref{text="inkbird_ibsth1_mini/inkbird_ibsth1_mini.h" path="inkbird_ibsth1_mini/inkbird_ibsth1_mini.h"}
