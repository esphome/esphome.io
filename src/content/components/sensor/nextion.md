...
some more advanced functions (see the full ::apiref{text="nextion/sensor/nextion_sensor.h" path="nextion/sensor/nextion_sensor.h"} for more info).
...
- [Link](index/)
- ::apiref{text="nextion/sensor/nextion_sensor.h" path="nextion/sensor/nextion_sensor.h"}
