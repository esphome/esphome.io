...
description: >-
  Instructions for setting up BME680 temperature, humidity, pressure, and gas
  sensors via BSEC.
seo:
  description: >-
    Instructions for setting up BME680 temperature, humidity, pressure, and gas
...
>
> - We recommend using the newer [bme68x_bsec2](bme68x_bsec2) component whenever possible.
...
- [Link](bme680/)
- ::apiref{text="bme680_bsec/bme680_bsec.h" path="bme680_bsec/bme680_bsec.h"}
