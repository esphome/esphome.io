...
For text/string values, see [ble_client](/components/text_sensor/ble_client).

For more information on BLE services and characteristics, see [ble_client](/components/ble_client).
...
- [ble_client](/components/ble_client)
- [ble_client](/components/text_sensor/ble_client)
- [Sensor Filters](/components/sensor#sensor-filters)
- ::apiref{text="ble_sensor/ble_sensor.h" path="ble_sensor/ble_sensor.h"}
