...
description: >-
  Instructions for setting up WiFi signal sensors that track the RSSI connection
  strength value to the network.
seo:
  description: >-
    Instructions for setting up WiFi signal sensors that track the RSSI
    connection strength value to the network.
...
- [wifi_info](/components/text_sensor/wifi_info)
- ::apiref{text="wifi_signal/wifi_signal_sensor.h" path="wifi_signal/wifi_signal_sensor.h"}
