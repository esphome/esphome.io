...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Link](ld2450/) component.
...
- **ld2450_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [Link](ld2450/) component.
...
The `ld2450` switch allows you to control your [Link](ld2450/) `Bluetooth` and `Multi/Single Target Tracking`.
...
- **ld2450_id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for the [Link](ld2450/) component if you are
...
The `ld2450` button allows you to perform `restart` and `factory reset` actions on your [Link](ld2450/).
...
The `ld2450` text sensor allows you to get information about your [Link](ld2450/).
...
The `ld2450` select allows you to control `baud rate` and `zone type` of your [Link](ld2450/).
...
Here is the complete example configuration for [Link](ld2450/).
