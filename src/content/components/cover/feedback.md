...
It is a drop-in replacement of [time_based](/components/cover/time_based)
...
It can be used to replace a [current_based](/components/cover/current_based), with some modifications in the yaml. See [Migrating Current-Based Cover](#migrating_current_based)
...
1. All current sensing related options must be moved to auxiliary [analog_threshold](/components/binary_sensor/analog_threshold),
...
- ::apiref{text="feedback/feedback_cover.h" path="feedback/feedback_cover.h"}
