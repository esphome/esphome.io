...
description: >-
  Instructions for setting up the deep sleep support for minimizing power
  consumption on ESPs.
seo:
  description: >-
    Instructions for setting up the deep sleep support for minimizing power
...
- ::apiref{text="deep_sleep/deep_sleep_component.h" path="deep_sleep/deep_sleep_component.h"}
