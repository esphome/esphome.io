...
description: >-
  Instructions for setting up addressable lights like NEOPIXEL on an ESP32 using
  the RMT peripheral.
seo:
  description: >-
    Instructions for setting up addressable lights like NEOPIXEL on an ESP32
    using the RMT peripheral.
...
- ::apiref{text="esp32_rmt_led_strip/esp32_rmt_led_strip.h" path="esp32_rmt_led_strip/esp32_rmt_led_strip.h"}
