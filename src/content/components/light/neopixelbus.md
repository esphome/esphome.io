...
>
> For clockless lights, you can use [Link](esp32_rmt_led_strip/), and for SPI LEDs see [Link](spi_led_strip/).
...
It is very similar to the [Link](fastled/) platform.
...
- ::apiref{text="neopixelbus/neopixelbus_light.h" path="neopixelbus/neopixelbus_light.h"}
