...
> [!WARNING]
> FastLED does **not** work as expected with Arduino 3 or newer for ESP8266. For now, you can either downgrade the arduino version or use [Link](neopixelbus/).
>
> ```yaml
> esp8266:
>   framework:
...
>
> For addressable lights, you can use [Link](esp32_rmt_led_strip/) or for SPI LEDs see [Link](spi_led_strip/)..
...
See [spi_led_strip](/components/light/spi_led_strip) for an alternative component that works on ESP-IDF (and Arduino.)
...
- [spi_led_strip](/components/light/spi_led_strip)
- [power_supply](/components/power_supply)
- ::apiref{text="fastled_base/fastled_light.h" path="fastled_base/fastled_light.h"}
