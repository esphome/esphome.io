...
- **power_supply** (*Optional*, [ID](/guides/configuration-types#id)): The [power_supply](/components/power_supply) to connect to this light. When
...
- ::apiref{text="light/light_state.h" path="light/light_state.h"}
