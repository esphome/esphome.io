...
(like [Link](fastled/) or [Link](neopixelbus/)) and/or individual lights (like [Link](rgb/)) into a single addressable light.
...
- [neopixelbus](/components/light/neopixelbus)
- ::apiref{text="partition/light_partition.h" path="partition/light_partition.h"}
