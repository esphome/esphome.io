...
description: >-
  Instructions for setting up addressable lights like NEOPIXEL on a Beken chip
  using the SPI DMA interface.
seo:
  description: >-
    Instructions for setting up addressable lights like NEOPIXEL on a Beken chip
    using the SPI DMA interface.
...
- ::apiref{text="beken_spi_led_strip/beken_spi_led_strip.h" path="beken_spi_led_strip/beken_spi_led_strip.h"}
