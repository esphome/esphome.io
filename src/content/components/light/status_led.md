...
description: >-
  Instructions for setting up a Status LED shared also as binary ON/OFF light in
  ESPHome.
seo:
  description: >-
    Instructions for setting up a Status LED shared also as binary ON/OFF light
    in ESPHome.
  image: led-on.svg
---
