...
description: >-
  Instructions for setting up USB CDC-ACM virtual serial ports on ESP32 variants
  in ESPHome
seo:
  description: >-
    Instructions for setting up USB CDC-ACM virtual serial ports on ESP32
    variants in ESPHome
  image: usb.svg
---
...
- ::apiref{text="usb_cdc_acm/usb_cdc_acm.h" path="usb_cdc_acm/usb_cdc_acm.h"}
