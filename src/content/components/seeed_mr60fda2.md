...
description: >-
  Instructions for setting up Seeed Studio MR60FDA2 60GHz mmWave Fall Detection
  Sensor Kit.
seo:
  description: >-
    Instructions for setting up Seeed Studio MR60FDA2 60GHz mmWave Fall
    Detection Sensor Kit.
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Link](seeed_mr60fda2/) component if you need multiple components.
...
- ::apiref{text="seeed_mr60fda2/seeed_mr60fda2.h" path="seeed_mr60fda2/seeed_mr60fda2.h"}
