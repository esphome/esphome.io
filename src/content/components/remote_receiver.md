...
description: >-
  Instructions for setting up remote receiver binary sensors for infrared and RF
  codes.
seo:
  description: >-
    Instructions for setting up remote receiver binary sensors for infrared and
    RF codes.
  image: remote.svg
---
...
- [Link](index/)
- [remote_transmitter](/components/remote_transmitter)
...
- ::apiref{text="remote/remote_receiver.h" path="remote/remote_receiver.h"}
