...
description: >-
  Instructions for setting up MCP23S08, MCP23S16 or MCP23S17 digital port
  expander in ESPHome. This series features exactly the same API as the MCP230xx
  I/O Expander (I²C)
seo:
  description: >-
    Instructions for setting up MCP23S08, MCP23S16 or MCP23S17 digital port
    expander in ESPHome. This series features exactly the same API as the
    MCP230xx I/O Expander (I²C)
  image: mcp230xx.svg
---
