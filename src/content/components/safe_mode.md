...
title: Safe Mode
description: >-
  Instructions for setting up ESPHome's Safe Mode to help recover from repeated
  boot failures.
seo:
  description: >-
    Instructions for setting up ESPHome's Safe Mode to help recover from
...
- ::apiref{text="safe_mode/safe_mode.h" path="safe_mode/safe_mode.h"}
