...
description: >-
  Instructions for setting up the Ethernet configuration for your ESP32 node in
  ESPHome.
seo:
  description: >-
    Instructions for setting up the Ethernet configuration for your ESP32 node
    in ESPHome.
  image: ethernet.svg
---
...
> [!NOTE]
> SPI based chips do *not* use [Link](spi/). This means that SPI pins can't be shared with other devices.
...
- [Link](network/)
- [ethernet_info](text_sensor/ethernet_info)
- ::apiref{text="ethernet/ethernet_component.h" path="ethernet/ethernet_component.h"}
