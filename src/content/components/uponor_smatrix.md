...
- **time_id** (*Optional*, [ID](/guides/configuration-types#id)): Specify the ID of the
  [Time Component](time/index) to use as the time source if you want ESPHome to automatically
...
- ::apiref{text="uponor_smatrix/uponor_smatrix.h" path="uponor_smatrix/uponor_smatrix.h"}
