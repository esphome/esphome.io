...
> - cannot be used with the [usb_host](/components/usb_host); operation as both a host and a device simultaneously
>   is not possible.
...
- ::apiref{text="tinyusb/tinyusb_component.h" path="tinyusb/tinyusb_component.h"}
